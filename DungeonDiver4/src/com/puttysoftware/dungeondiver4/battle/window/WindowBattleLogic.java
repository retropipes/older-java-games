package com.puttysoftware.dungeondiver4.battle.window;
...
public class WindowBattleLogic extends AbstractBattle {
    ...
    final int computeRunChance() {
        return AbstractBattle.BASE_RUN_CHANCE - this.enemy.getLevelDifference()
                * AbstractBattle.RUN_CHANCE_DIFF_FACTOR;
    }
    ...
    final void updateMessageAreaEnemyFleeFailed() {
        ...
        SoundManager.playSound(SoundConstants.SOUND_RUN_FAILED);
    }
