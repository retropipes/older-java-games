 ...
 */
package com.puttysoftware.dungeondiver4.editor.namer.editor;
...
import com.puttysoftware.dungeondiver4.editor.namer.abc.AbstractObjectEditor;
...
public class NameEditor extends AbstractObjectEditor {
    ...
    protected void loadObject() {
        this.cachedNames = DungeonDiver4.getApplication().getScenarioManager()
                .getNamesFileManager().getNames();
    }

    @Override
    protected void saveObject() {
        DungeonDiver4.getApplication().getScenarioManager()
