...
public class LaserTank {
    ...
    public static void logNonFatalError(final Throwable t) {
        ...
        CommonDialogs.showTitledDialog(LaserTank.NONFATAL_MESSAGE,
                LaserTank.NONFATAL_TITLE);
    }
    ...
    private static void initStrings() {
        ...
        LaserTank.ERROR_MESSAGE = StringLoader
                .loadError(ErrorString.ERROR_MESSAGE);
        LaserTank.NONFATAL_TITLE = StringLoader
                .loadError(ErrorString.NONFATAL_TITLE);
        LaserTank.NONFATAL_MESSAGE = StringLoader
                .loadError(ErrorString.NONFATAL_MESSAGE);
    }
    ...
    public static void main(final String[] args) {
        try {
            ...
            final EventThreadUEH etueh = new EventThreadUEH();
            final EventThreadUEHInstaller etuehi = new EventThreadUEHInstaller(
                    etueh);
