...
public class ArenaObjectList {
    ...
    public AbstractArenaObject readArenaObjectG2(final XMLFileReader reader,
    ...
    public AbstractArenaObject readArenaObjectG3(final XMLFileReader reader,
            final int formatVersion) throws IOException {
        AbstractArenaObject o = null;
        String UID = StringLoader.loadCommon(CommonString.SPACE);
    ...
    public AbstractArenaObject readArenaObjectG4(final XMLFileReader reader,
            final int formatVersion) throws IOException {
        AbstractArenaObject o = null;
        String UID = StringLoader.loadCommon(CommonString.SPACE);
    ...
    public AbstractArenaObject readArenaObjectG5(final XMLFileReader reader,
            final int formatVersion) throws IOException {
        AbstractArenaObject o = null;
        String UID = StringLoader.loadCommon(CommonString.SPACE);
    ...
    public AbstractArenaObject readArenaObjectG6(final XMLFileReader reader,
            final int formatVersion) throws IOException {
        AbstractArenaObject o = null;
        String UID = StringLoader.loadCommon(CommonString.SPACE);
