...
class SolidDataFileNames {
    // Static fields
    private static String[] LIST = new String[] { "solid_blue_laser",
            "solid_green_laser", "solid_heat_laser", "solid_other",
            "solid_power_laser", "solid_red_laser", "solid_shadow_laser" };
