...
public class LaserTankPlayback {
    ...
    private static Entry[] decodeRawData(final byte[] d)
    ...
    public static LaserTankPlayback loadFromFile(final File file)
            throws IOException {
    ...
    public static LaserTankPlayback loadFromResource(final String resource)
            throws IOException {
        try (InputStream fs = LaserTankPlayback.class
    ...
    // Internal stuff
    private static LaserTankPlayback loadFromStream(final InputStream fs)
            throws IOException {
        int bytesRead = 0;
        // Load level name
        ...
        final String loadLevelName = GameIOUtilities
                .decodeWindowsStringData(levelNameData);
        // Load author
        ...
        final int loadLevelNumber = GameIOUtilities
                .unsignedShortByteArrayToInt(levelNumberData);
        // Load recording size
        ...
        final int recordingSize = GameIOUtilities
                .unsignedShortByteArrayToInt(levelNumberData);
        ...
        final Entry[] loadRecordingData = LaserTankPlayback
                .decodeRawData(rawRecordingData);
        // Return final result
        return new LaserTankPlayback(loadLevelName, loadAuthor, loadLevelNumber,
                loadRecordingData);
    }
    ...
    private LaserTankPlayback(final String loadLevelName,
            final String loadAuthor, final int loadLevelNumber,
