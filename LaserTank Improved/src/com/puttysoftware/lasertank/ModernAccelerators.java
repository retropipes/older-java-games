...
class ModernAccelerators extends Accelerators {
    ModernAccelerators() {
        ...
        this.editorRedoAccel = KeyStroke.getKeyStroke(KeyEvent.VK_Z,
                modKey | InputEvent.SHIFT_DOWN_MASK);
        this.editorCutLevelAccel = KeyStroke.getKeyStroke(KeyEvent.VK_X,
                modKey);
        this.editorCopyLevelAccel = KeyStroke.getKeyStroke(KeyEvent.VK_C,
                modKey);
        this.editorPasteLevelAccel = KeyStroke.getKeyStroke(KeyEvent.VK_V,
                modKey);
        this.editorInsertLevelFromClipboardAccel = KeyStroke
                .getKeyStroke(KeyEvent.VK_F, modKey);
        this.filePreferencesAccel = KeyStroke.getKeyStroke(KeyEvent.VK_COMMA,
                modKey);
        this.editorClearHistoryAccel = KeyStroke.getKeyStroke(KeyEvent.VK_Y,
                modKey);
        this.editorGoToLocationAccel = KeyStroke.getKeyStroke(KeyEvent.VK_G,
                modKey | InputEvent.SHIFT_DOWN_MASK);
        this.playPlayArenaAccel = KeyStroke.getKeyStroke(KeyEvent.VK_P,
                modKey | InputEvent.SHIFT_DOWN_MASK);
