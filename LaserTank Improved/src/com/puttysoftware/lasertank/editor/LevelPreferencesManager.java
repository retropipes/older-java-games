...
class LevelPreferencesManager {
    ...
    private void setUpGUI() {
        ...
        this.prefFrame = new JFrame(
                StringLoader.loadEditor(EditorString.LEVEL_PREFERENCES));
        ...
        this.horizontalWrap = new JCheckBox(StringLoader
                .loadEditor(EditorString.ENABLE_HORIZONTAL_WRAP_AROUND), false);
        this.verticalWrap = new JCheckBox(StringLoader
                .loadEditor(EditorString.ENABLE_VERTICAL_WRAP_AROUND), false);
        this.thirdWrap = new JCheckBox(
                StringLoader.loadEditor(
                        EditorString.ENABLE_THIRD_DIMENSION_WRAP_AROUND),
                false);
        ...
        this.moveShoot = new JCheckBox(
                StringLoader.loadEditor(EditorString.ENABLE_MOVE_SHOOT), true);
        ...
        contentPane.add(
                new JLabel(StringLoader.loadEditor(EditorString.LEVEL_NAME)));
        contentPane.add(this.name);
        contentPane.add(
                new JLabel(StringLoader.loadEditor(EditorString.LEVEL_AUTHOR)));
        contentPane.add(this.author);
        contentPane.add(
                new JLabel(StringLoader.loadEditor(EditorString.LEVEL_HINT)));
        contentPane.add(this.hint);
        contentPane.add(new JLabel(
                StringLoader.loadEditor(EditorString.LEVEL_DIFFICULTY)));
