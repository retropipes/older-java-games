...
public class CurrentArena extends AbstractArena {
    ...
    public CurrentArena() throws IOException {
        ...
        this.basePath = System.getProperty(
                GlobalLoader.loadUntranslated(UntranslatedString.TEMP_DIR))
                + File.separator
                + GlobalLoader.loadUntranslated(UntranslatedString.PROGRAM_NAME)
                + File.separator + randomID + GlobalLoader.loadUntranslated(
                        UntranslatedString.ARENA_FORMAT_FOLDER);
    ...
    private String generateCurrentLevelInfo() {
        ...
        sb.append(StringLoader.loadCommon(CommonString.COLON)
    ...
    public String getArenaTempMusicFolder() {
        return this.basePath + File.separator
                + GlobalLoader.loadUntranslated(UntranslatedString.MUSIC_FOLDER)
                + File.separator;
    }
    ...
    private File getLevelFile(final int level, final int era) {
        return new File(this.basePath + File.separator
                + GlobalLoader
                        .loadUntranslated(UntranslatedString.ARENA_FORMAT_LEVEL)
                + level
                + GlobalLoader
                        .loadUntranslated(UntranslatedString.ARENA_FORMAT_ERA)
        ...
        return new XMLFileReader(
                this.basePath + File.separator
                        + GlobalLoader.loadUntranslated(
                                UntranslatedString.ARENA_FORMAT_LEVEL)
                        + this.activeLevel
    ...
    private XMLFileReader getLevelReaderG6() throws IOException {
        return new XMLFileReader(
                this.basePath + File.separator
                        ...
                        + this.activeLevel
                        + GlobalLoader.loadUntranslated(
                                UntranslatedString.ARENA_FORMAT_ERA)
                        + this.activeEra
                        + Extension.getArenaLevelExtensionWithPeriod(),
                GlobalLoader.loadUntranslated(
                        UntranslatedString.ARENA_FORMAT_LEVEL));
    ...
    public CurrentArena readArena() throws IOException {
        ...
        try (XMLFileReader metaReader = new XMLFileReader(
                m.basePath + File.separator
                        + GlobalLoader.loadUntranslated(
                                UntranslatedString.ARENA_FORMAT_METAFILE)
                        + Extension.getArenaLevelExtensionWithPeriod(),
                GlobalLoader.loadUntranslated(
                        UntranslatedString.ARENA_FORMAT_ARENA))) {
            // Read metafile
    ...
    private void readArenaLevel(final XMLFileReader reader,
    ...
    private void readArenaMetafileG3(final XMLFileReader reader, final int ver)
            throws IOException {
    ...
    private void readArenaMetafileG4(final XMLFileReader reader, final int ver)
            throws IOException {
        this.levelCount = reader.readInt();
    ...
    private void readArenaMetafileG6(final XMLFileReader reader, final int ver)
            throws IOException {
        this.levelCount = reader.readInt();
        this.musicFilename = reader.readString();
    ...
    private int readArenaMetafileVersion(final XMLFileReader reader)
            throws IOException {
    ...
    private void writeArenaLevel(final XMLFileWriter writer)
            throws IOException {
        // Write the level
    ...
    private void writeArenaMetafile(final XMLFileWriter writer)
            throws IOException {
        if (this.prefixHandler != null) {
