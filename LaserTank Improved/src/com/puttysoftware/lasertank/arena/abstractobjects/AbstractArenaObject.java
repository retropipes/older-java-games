...
public abstract class AbstractArenaObject extends CloneableObject {
    ...
    public AbstractArenaObject clone() {
        try {
            final AbstractArenaObject copy = this.getClass().getConstructor()
                    .newInstance();
    ...
    private final String getDirectionSuffix() {
        if (this.hasDirection()) {
            return DirectionResolver
                    .resolveConstantToImageSuffix(this.direction);
        } else {
    ...
    private final String getFrameSuffix() {
        if (this.isAnimated()) {
            return FrameResolver
                    .resolveFrameNumberToImageSuffix(this.frameNumber);
        } else {
            return StringLoader.loadCommon(CommonString.EMPTY);
        }
    }
    ...
    public final String getImageName() {
        return this.getBaseImageName() + this.getDirectionSuffix()
                + this.getFrameSuffix();
    }
    ...
    public final AbstractArenaObject readArenaObjectG2(
            final XMLFileReader reader, final String ident, final int ver)
            throws IOException {
    ...
    public final AbstractArenaObject readArenaObjectG3(
            final XMLFileReader reader, final String ident, final int ver)
            throws IOException {
        if (ident.equals(this.getIdentifier())) {
            final int cc = this.getCustomFormat();
    ...
    public final AbstractArenaObject readArenaObjectG4(
            final XMLFileReader reader, final String ident, final int ver)
            throws IOException {
        if (ident.equals(this.getIdentifier())) {
            final int cc = this.getCustomFormat();
    ...
    public final AbstractArenaObject readArenaObjectG5(
            final XMLFileReader reader, final String ident, final int ver)
            throws IOException {
        if (ident.equals(this.getIdentifier())) {
            final int cc = this.getCustomFormat();
    ...
    public final AbstractArenaObject readArenaObjectG6(
            final XMLFileReader reader, final String ident, final int ver)
            throws IOException {
        if (ident.equals(this.getIdentifier())) {
            final int cc = this.getCustomFormat();
    ...
    public final void writeArenaObject(final XMLFileWriter writer)
            throws IOException {
