...
public abstract class AbstractArenaData implements Cloneable {
    ...
    public abstract void readSavedState(final XMLFileReader reader,
    ...
    public abstract void writeData(final AbstractArena arena,
            final XMLFileWriter writer) throws IOException;

    public abstract void writeSavedState(final XMLFileWriter writer)
            throws IOException;
}
