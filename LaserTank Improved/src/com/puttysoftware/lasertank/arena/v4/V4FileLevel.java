...
class V4FileLevel {
    ...
    static CurrentArenaData loadAndConvert(final FileInputStream file,
        ...
        try {
            ...
            int bytesRead = file.read(V4FileLevel.objects, 0,
                    V4FileLevel.OBJECTS_SIZE);
            ...
            final String levelName = Charset
                    .forName(GlobalLoader.loadUntranslated(
                            UntranslatedString.DEFAULT_CHARSET))
            ...
            bytesRead = file.read(V4FileLevel.author, 0,
                    V4FileLevel.AUTHOR_SIZE);
            ...
            bytesRead = file.read(V4FileLevel.difficulty, 0,
                    V4FileLevel.DIFFICULTY_SIZE);
