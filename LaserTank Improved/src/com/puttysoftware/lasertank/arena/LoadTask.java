...
public class LoadTask extends Thread {
    ...
    public LoadTask(final String file, final boolean saved,
        ...
        this.setName(GlobalLoader
                .loadUntranslated(UntranslatedString.NEW_AG_LOADER_NAME));
        ...
        try {
            ...
            if (this.arenaProtected) {
                ...
                try {
                    ...
                    CommonDialogs.showErrorDialog(
                            StringLoader
                                    .loadError(ErrorString.BAD_PROTECTION_KEY),
            ...
            if (gameArena == null) {
                throw new InvalidArenaException(
                        StringLoader.loadError(ErrorString.UNKNOWN_OBJECT));
            }
            ...
            if (this.isSavedGame) {
                CommonDialogs.showDialog(StringLoader
                        .loadDialog(DialogString.GAME_LOADING_SUCCESS));
            } else {
                CommonDialogs.showDialog(StringLoader
            ...
            if (this.isSavedGame) {
                CommonDialogs.showDialog(StringLoader
                        .loadDialog(DialogString.GAME_LOADING_FAILED));
            } else {
                CommonDialogs.showDialog(StringLoader
                        .loadDialog(DialogString.ARENA_LOADING_FAILED));
            }
            app.getArenaManager().handleDeferredSuccess(false);
