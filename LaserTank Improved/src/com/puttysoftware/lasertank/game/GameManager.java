...
public class GameManager {
            ...
            try {
                ...
                if (!gm.getCheatStatus(GameManager.CHEAT_BOMBS)
                    ...
                    CommonDialogs.showDialog(
                            StringLoader.loadGame(GameString.OUT_OF_BOMBS));
                }
            } catch (final Exception ex) {
                LaserTank.logError(ex);
            }
        ...
        public void handleBoosts(final KeyEvent e) {
            try {
                ...
                if (!gm.getCheatStatus(GameManager.CHEAT_BOOSTS)
                    ...
                    CommonDialogs.showDialog(
                            StringLoader.loadGame(GameString.OUT_OF_BOOSTS));
                }
            } catch (final Exception ex) {
                LaserTank.logError(ex);
            }
            ...
            try {
                ...
                if (!gm.getCheatStatus(GameManager.CHEAT_HEAT_BOMBS)
                    ...
                    CommonDialogs.showDialog(StringLoader
                            .loadGame(GameString.OUT_OF_HEAT_BOMBS));
                }
            } catch (final Exception ex) {
                LaserTank.logError(ex);
            }
        ...
        public void handleIceBombs() {
            try {
                ...
                if (!gm.getCheatStatus(GameManager.CHEAT_ICE_BOMBS)
                    ...
                    CommonDialogs.showDialog(
                            StringLoader.loadGame(GameString.OUT_OF_ICE_BOMBS));
                }
            } catch (final Exception ex) {
                LaserTank.logError(ex);
            }
        ...
        public void handleMagnets(final KeyEvent e) {
            try {
                ...
                if (!gm.getCheatStatus(GameManager.CHEAT_MAGNETS)
                    ...
                    CommonDialogs.showDialog(
                            StringLoader.loadGame(GameString.OUT_OF_MAGNETS));
                }
            } catch (final Exception ex) {
                LaserTank.logError(ex);
            }
    ...
    private static String[] OTHER_AMMO_CHOICES = new String[] {
            StringLoader.loadGame(GameString.MISSILES),
            StringLoader.loadGame(GameString.STUNNERS),
            StringLoader.loadGame(GameString.BLUE_LASERS),
            StringLoader.loadGame(GameString.DISRUPTORS) };
    private static String[] OTHER_TOOL_CHOICES = new String[] {
            StringLoader.loadGame(GameString.BOOSTS),
            StringLoader.loadGame(GameString.MAGNETS) };
    private static String[] OTHER_RANGE_CHOICES = new String[] {
            StringLoader.loadGame(GameString.BOMBS),
            StringLoader.loadGame(GameString.HEAT_BOMBS),
            StringLoader.loadGame(GameString.ICE_BOMBS) };
    ...
    public void changeOtherAmmoMode() {
        final String choice = CommonDialogs.showInputDialog(
                StringLoader.loadGame(GameString.WHICH_AMMO),
                StringLoader.loadGame(GameString.CHANGE_AMMO),
        ...
        if (choice != null) {
            ...
            CommonDialogs.showDialog(StringLoader
                    .loadGame(GameString.AMMO_CHANGED)
    ...
    public void changeOtherRangeMode() {
        final String choice = CommonDialogs.showInputDialog(
                StringLoader.loadGame(GameString.WHICH_RANGE),
                StringLoader.loadGame(GameString.CHANGE_RANGE),
        ...
        if (choice != null) {
            ...
            this.updateScoreText();
            CommonDialogs.showDialog(StringLoader
                    .loadGame(GameString.RANGE_CHANGED)
                    + StringLoader.loadCommon(CommonString.SPACE)
                    + GameManager.OTHER_RANGE_CHOICES[this.otherRangeMode]
                    + StringLoader.loadCommon(CommonString.NOTL_PERIOD));
        }
    ...
    public void changeOtherToolMode() {
        final String choice = CommonDialogs.showInputDialog(
                StringLoader.loadGame(GameString.WHICH_TOOL),
                StringLoader.loadGame(GameString.CHANGE_TOOL),
        ...
        if (choice != null) {
            ...
            this.updateScoreText();
            CommonDialogs.showDialog(StringLoader
                    .loadGame(GameString.TOOL_CHANGED)
                    + StringLoader.loadCommon(CommonString.SPACE)
                    + GameManager.OTHER_TOOL_CHOICES[this.otherToolMode]
                    + StringLoader.loadCommon(CommonString.NOTL_PERIOD));
        }
    ...
    public void enterCheatCode() {
        ...
        if (rawCheat != null) {
            if (rawCheat
                    .contains(StringLoader.loadGame(GameString.ENABLE_CHEAT))) {
                // Enable cheat
    ...
    public boolean fireLaser(final int ox, final int oy,
        ...
        if (this.otherAmmoMode == GameManager.OTHER_AMMO_MODE_MISSILES
            ...
            CommonDialogs.showDialog(
                    StringLoader.loadGame(GameString.OUT_OF_MISSILES));
            ...
            CommonDialogs.showDialog(
                    StringLoader.loadGame(GameString.OUT_OF_STUNNERS));
            ...
            CommonDialogs.showDialog(
                    StringLoader.loadGame(GameString.OUT_OF_BLUE_LASERS));
            ...
            CommonDialogs.showDialog(
                    StringLoader.loadGame(GameString.OUT_OF_DISRUPTORS));
        } else {
            final AbstractArena a = LaserTank.getApplication().getArenaManager()
                    .getArena();
            if (!a.isMoveShootAllowed() && !this.laserActive
                ...
                final int[] currDirection = DirectionResolver
                        .unresolveRelative(shooter.getDirection());
        ...
        if (choice == JOptionPane.CANCEL_OPTION) {
            ...
            try {
                ...
                CommonDialogs.showErrorDialog(
                        StringLoader.loadError(ErrorString.TANK_LOCATION),
    ...
    public void loadGameHookG1(final XMLFileReader arenaFile)
            throws IOException {
        final Application app = LaserTank.getApplication();
    ...
    public void loadGameHookG2(final XMLFileReader arenaFile)
            throws IOException {
        final Application app = LaserTank.getApplication();
        app.getArenaManager().setScoresFileName(arenaFile.readString());
        this.st.setMoves(arenaFile.readLong());
    ...
    public void loadGameHookG3(final XMLFileReader arenaFile)
            throws IOException {
        final Application app = LaserTank.getApplication();
        app.getArenaManager().setScoresFileName(arenaFile.readString());
        this.st.setMoves(arenaFile.readLong());
    ...
    public void loadGameHookG4(final XMLFileReader arenaFile)
            throws IOException {
        final Application app = LaserTank.getApplication();
        app.getArenaManager().setScoresFileName(arenaFile.readString());
        this.st.setMoves(arenaFile.readLong());
    ...
    public void loadGameHookG5(final XMLFileReader arenaFile)
            throws IOException {
        final Application app = LaserTank.getApplication();
        app.getArenaManager().setScoresFileName(arenaFile.readString());
        this.st.setMoves(arenaFile.readLong());
    ...
    public void loadGameHookG6(final XMLFileReader arenaFile)
            throws IOException {
        final Application app = LaserTank.getApplication();
        app.getArenaManager().setScoresFileName(arenaFile.readString());
        this.st.setMoves(arenaFile.readLong());
    ...
    public void loadLevel() {
        ...
        final String res = CommonDialogs.showInputDialog(
                StringLoader.loadGame(GameString.LOAD_LEVEL_PROMPT),
                StringLoader.loadGame(GameString.LOAD_LEVEL), choices,
                choices[m.getActiveLevelNumber()]);
        int number = -1;
    ...
    public void playArena() {
        ...
        if (app.getArenaManager().getLoaded()) {
            ...
            if (res) {
                ...
                CommonDialogs.showDialog(StringLoader
                        .loadGame(GameString.NO_LEVEL_WITH_DIFFICULTY));
                LaserTank.getApplication().getGUIManager().showGUI();
            }
        } else {
            CommonDialogs.showDialog(
                    StringLoader.loadMenu(MenuString.ERROR_NO_ARENA_OPENED));
        }
    }
    ...
    public void previousLevel() {
        ...
        if (m.doesLevelExistOffset(-1)) {
            ...
            if (levelExists) {
                ...
                CommonDialogs.showErrorDialog(
                        StringLoader.loadError(ErrorString.NO_PREVIOUS_LEVEL),
                        GlobalLoader.loadUntranslated(
                                UntranslatedString.PROGRAM_NAME));
            }
        } else {
    ...
    private void processLevelExists() {
        ...
        this.scoreMoves.setText(StringLoader.loadGame(GameString.MOVES)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO));
        this.scoreShots.setText(StringLoader.loadGame(GameString.SHOTS)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO));
        this.scoreOthers.setText(StringLoader.loadGame(GameString.OTHERS)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO));
        if (this.otherAmmoMode == GameManager.OTHER_AMMO_MODE_MISSILES) {
            if (this.getCheatStatus(GameManager.CHEAT_MISSILES)) {
                this.otherAmmoLeft.setText(
                        StringLoader.loadCommon(CommonString.OPEN_PARENTHESES)
                                + StringLoader.loadGame(GameString.MISSILES)
                                + StringLoader.loadCommon(CommonString.COLON)
                                + StringLoader.loadCommon(CommonString.SPACE)
                                + StringLoader.loadGame(GameString.INFINITE)
                                + StringLoader.loadCommon(
                                        CommonString.CLOSE_PARENTHESES));
            } else {
                this.otherAmmoLeft.setText(
                        StringLoader.loadCommon(CommonString.OPEN_PARENTHESES)
                                + StringLoader.loadGame(GameString.MISSILES)
    ...
    private boolean readSolution() {
        try {
            ...
            final String filename = levelFile
                    + StringLoader.loadCommon(CommonString.UNDERSCORE)
                    + activeLevel + Extension.getSolutionExtensionWithPeriod();
            try (XMLFileReader file = new XMLFileReader(filename, GlobalLoader
                    .loadUntranslated(UntranslatedString.SOLUTION))) {
        ...
        for (x = GameViewingWindowManager
            ...
            for (y = GameViewingWindowManager
                ...
                if (a.isCellDirty(y, x, pz)) {
                    ...
                    final AbstractArenaObject vbobj = a.getVirtualCell(y, x, pz,
                    ...
                    drawGrid.setImageCell(ImageManager.getVirtualCompositeImage(
                            gbobj, gtobj, obobj, otobj, vbobj), x, y);
                }
            }
        }
    ...
    boolean replayLastMove() {
        if (this.gre.tryRedo()) {
            ...
            if (laser) {
                ...
                final Direction newDir = DirectionResolver.resolveRelative(x,
                        y);
                if (currDir != newDir) {
    ...
    public void replaySolution() {
        final MenuManager menu = LaserTank.getApplication().getMenuManager();
        if (this.lpbLoaded) {
            this.replaying = true;
            // Turn recording off
            this.recording = false;
            ...
            if (!success) {
                CommonDialogs.showErrorDialog(
                        StringLoader.loadError(ErrorString.NO_SOLUTION_FILE),
                        GlobalLoader.loadUntranslated(
                                UntranslatedString.PROGRAM_NAME));
            } else {
                this.replaying = true;
    ...
    private void setUpDifficultyDialog() {
        ...
        this.difficultyFrame = new JDialog((JFrame) null,
                StringLoader.loadGame(GameString.SELECT_DIFFICULTY));
        ...
        final JButton cancelButton = new JButton(
                StringLoader.loadDialog(DialogString.CANCEL_BUTTON));
    ...
    private void setUpGUI() {
        ...
        this.scoreMoves = new JLabel(StringLoader.loadGame(GameString.MOVES)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO));
        this.scoreShots = new JLabel(StringLoader.loadGame(GameString.SHOTS)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO));
        this.scoreOthers = new JLabel(StringLoader.loadGame(GameString.OTHERS)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO));
        this.otherAmmoLeft = new JLabel(StringLoader
                .loadCommon(CommonString.OPEN_PARENTHESES)
                + StringLoader.loadGame(GameString.MISSILES)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO)
                + StringLoader.loadCommon(CommonString.CLOSE_PARENTHESES));
        this.otherToolsLeft = new JLabel(StringLoader
                .loadCommon(CommonString.OPEN_PARENTHESES)
                + StringLoader.loadGame(GameString.BOOSTS)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadCommon(CommonString.ZERO)
                + StringLoader.loadCommon(CommonString.CLOSE_PARENTHESES));
        this.otherRangesLeft = new JLabel(StringLoader
                .loadCommon(CommonString.OPEN_PARENTHESES)
                + StringLoader.loadGame(GameString.BOMBS)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
    ...
    private void updateInfo() {
        final AbstractArena a = LaserTank.getApplication().getArenaManager()
                .getArena();
        this.levelInfo.setText(StringLoader.loadGame(GameString.LEVEL)
                + StringLoader.loadCommon(CommonString.SPACE)
                ...
                + a.getName().trim()
                + StringLoader.loadCommon(CommonString.SPACE)
                + StringLoader.loadDialog(DialogString.ARENA_LEVEL_BY)
                + StringLoader.loadCommon(CommonString.SPACE)
                + a.getAuthor().trim());
    }
    ...
    public void updatePositionAbsoluteNoEvents(final int x, final int y,
        ...
        try {
            ...
            m.setCell(this.tank, this.plMgr.getPlayerLocationX(),
                    this.plMgr.getPlayerLocationY(),
                    this.plMgr.getPlayerLocationZ(), template.getLayer());
            LaserTank.getApplication().showMessage(
                    StringLoader.loadGame(GameString.OUTSIDE_ARENA));
        } catch (final NullPointerException np) {
            this.plMgr.restorePlayerLocation();
            m.setCell(this.tank, this.plMgr.getPlayerLocationX(),
                    this.plMgr.getPlayerLocationY(),
    ...
    private void updateScore() {
        ...
        this.scoreShots.setText(StringLoader.loadGame(GameString.SHOTS)
                ...
                + StringLoader.loadCommon(CommonString.SPACE)
                + this.st.getShots());
        this.scoreShots.setText(StringLoader.loadGame(GameString.OTHERS)
                + StringLoader.loadCommon(CommonString.COLON)
                + StringLoader.loadCommon(CommonString.SPACE)
                + this.st.getOthers());
        this.updateScoreText();
    ...
    private void writeSolution() {
        try {
            ...
            final String filename = levelFile
                    + StringLoader.loadCommon(CommonString.UNDERSCORE)
                    + activeLevel + Extension.getSolutionExtensionWithPeriod();
            try (XMLFileWriter file = new XMLFileWriter(filename, GlobalLoader
                    .loadUntranslated(UntranslatedString.SOLUTION))) {
