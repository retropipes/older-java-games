...
class ScoreTracker {
    private static final String MAC_PREFIX = GlobalLoader
    ...
    private static final String UNIX_PREFIX = GlobalLoader
            .loadUntranslated(UntranslatedString.DIRECTORY_UNIX_HOME);
    private static final String MAC_DIR = GlobalLoader
            .loadUntranslated(UntranslatedString.DIRECTORY_SCORES_MAC);
    private static final String WIN_DIR = GlobalLoader
            .loadUntranslated(UntranslatedString.DIRECTORY_SCORES_WINDOWS);
    private static final String UNIX_DIR = GlobalLoader
            .loadUntranslated(UntranslatedString.DIRECTORY_SCORES_UNIX);
        ...
        if (this.trackScores) {
            ...
            if (this.trackScores) {
                ...
                this.ssMgr = new SavedScoreManager(10,
                        SortedScoreTable.SortOrder.DESCENDING,
    ...
    void showScoreTable() {
        if (this.trackScores) {
            ...
            CommonDialogs.showDialog(
                    StringLoader.loadGame(GameString.SCORES_UNAVAILABLE));
        }
    }
}
