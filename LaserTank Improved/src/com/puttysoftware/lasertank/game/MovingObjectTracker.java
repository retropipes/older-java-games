...
final class MovingObjectTracker {
    ...
    void activateObject(final int zx, final int zy, final int pushX,
        ...
        this.objCumY = zy;
        this.movingObj = gmo;
        this.belowUpper = LaserTank.getApplication().getArenaManager()
                .getArena().getCell(this.objCumX + this.objIncX * this.objMultX,
                        this.objCumY + this.objIncY * this.objMultY, pz,
                        ArenaConstants.LAYER_UPPER_GROUND);
        this.belowLower = LaserTank.getApplication().getArenaManager()
                .getArena().getCell(this.objCumX + this.objIncX * this.objMultX,
                        this.objCumY + this.objIncY * this.objMultY, pz,
        ...
        try {
            ...
            this.belowLower = LaserTank.getApplication().getArenaManager()
                    ...
                    .getCell(this.objCumX + this.objIncX * this.objMultX,
                            this.objCumY + this.objIncY * this.objMultY, pz,
                            ArenaConstants.LAYER_LOWER_GROUND);
            if (MovingObjectTracker.checkSolid(saved) && this.objMultX != 0
                    && this.objMultY != 0) {
                ...
                if (this.belowUpper == null || this.belowLower == null) {
                    ...
                    if (jumper.isOfType(TypeConstants.TYPE_ICY)) {
                        ...
                        this.objectCheck = true;
                            ...
                            && this.movingObj.isOfType(
                                    TypeConstants.TYPE_MOVABLE_MIRROR)) {
                ...
                if (this.belowUpper == null || this.belowLower == null) {
                    ...
                    if (this.movingObj.isOfType(TypeConstants.TYPE_ICY)) {
                        ...
                        this.objectCheck = true;
                            ...
                            .isOfType(TypeConstants.TYPE_ANTI_MOVER)
                            && this.movingObj
                                    .isOfType(TypeConstants.TYPE_ANTI)) {
                        // Handle anti-tank on anti-tank mover
                        final Direction dir = this.belowUpper.getDirection();
                        final int[] unres = DirectionResolver
                                .unresolveRelative(dir);
                        ...
                        this.objectCheck = true;
                            ...
                            .isOfType(TypeConstants.TYPE_BOX_MOVER)
                            && this.movingObj
                                    .isOfType(TypeConstants.TYPE_BOX)) {
                        // Handle box on box mover
                        final Direction dir = this.belowUpper.getDirection();
                        final int[] unres = DirectionResolver
                                .unresolveRelative(dir);
