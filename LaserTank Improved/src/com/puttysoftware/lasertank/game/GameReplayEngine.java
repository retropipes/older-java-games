...
class GameReplayEngine {
    ...
    private static class LinkList {
        public static LinkList read(final XMLFileReader reader)
                throws IOException {
    ...
    private static class LinkStack {
        public static LinkStack read(final XMLFileReader reader)
                throws IOException {
    ...
    static GameReplayEngine readReplay(final XMLFileReader reader)
            throws IOException {
