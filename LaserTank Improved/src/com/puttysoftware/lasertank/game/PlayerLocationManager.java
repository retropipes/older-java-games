...
public final class PlayerLocationManager {
    ...
    public PlayerLocationManager() {
        ...
        this.playerData = new NumberStorage(ArenaConstants.PLAYER_DIMS,
                ArenaConstants.NUM_PLAYERS);
        this.playerData.fill(-1);
        this.savedPlayerData = new NumberStorage(ArenaConstants.PLAYER_DIMS,
                ArenaConstants.NUM_PLAYERS);
        this.savedPlayerData.fill(-1);
        this.savedRemoteData = new NumberStorage(ArenaConstants.PLAYER_DIMS,
                ArenaConstants.NUM_PLAYERS);
