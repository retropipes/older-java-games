...
public class StringLoader {
    ...
    public static void activeLanguageChanged(final int newLanguageID) {
        ...
        StringLoader.LANGUAGE_NAME = GlobalLoader
                .loadLanguage(StringLoader.LANGUAGE_ID) + "/";
        ...
        if (StringLoader.LOCALIZED_LANGUAGES_CACHE == null) {
            ...
            try (final InputStream is = StringLoader.LOAD_CLASS
                ...
                CommonDialogs.showErrorDialog(
                        "Something has gone horribly wrong trying to load the local language data!",
                        "FATAL ERROR");
                LaserTank.logErrorDirectly(ioe);
            }
        }
        final int size = StringLoader.LOCALIZED_LANGUAGES_CACHE.size();
    ...
    private static void cacheFile(final StringFile file) {
        ...
        try (final InputStream is = StringLoader.LOAD_CLASS
            ...
            CommonDialogs.showErrorDialog(
                    "Something has gone horribly wrong trying to cache global string data!",
                    "FATAL ERROR");
            LaserTank.logErrorDirectly(ioe);
        }
    }
    ...
    public static String loadCommon(final CommonString str,
        ...
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
                    values[v].toString());
        }
        return string;
    }
    ...
    public static String loadDialog(final DialogString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.DIALOGS)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
                    values[v].toString());
    ...
    public static String loadDifficulty(final DifficultyString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.DIFFICULTY)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadEditor(final EditorString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.EDITOR)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadError(final ErrorString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.ERRORS)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadGame(final GameString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.GAME)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadGeneric(final GenericString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.GENERIC)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadMenu(final MenuString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.MENUS)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadMessage(final MessageString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.MESSAGES)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadPref(final PrefString str,
            final Object... values) {
        String string = StringLoader.getFromCache(StringFile.PREFS)
                .getProperty(Integer.toString(str.ordinal()));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
    ...
    public static String loadTime(final int strID, final Object... values) {
        String string = StringLoader.getFromCache(StringFile.TIME)
                .getProperty(Integer.toString(strID));
        for (int v = 0; v < values.length; v++) {
            string = string.replace(
                    StringLoader.REPLACE_PREFIX + Integer.toString(v),
                    values[v].toString());
