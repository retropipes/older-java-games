...
public class PreferencesManager {
                ...
                return PreferencesManager.storeMgr
                                .getBoolean(
                                                GlobalLoader.loadUntranslated(
                                                                UntranslatedString.PREFS_KEY_ENABLE_ANIMATION),
                                                true);
        }

        static int getActionDelay() {
                return PreferencesManager.storeMgr.getInteger(GlobalLoader
                                .loadUntranslated(UntranslatedString.PREFS_KEY_ACTION_DELAY),
                                2);
        }
        ...
        public static int getEditorLayoutID() {
                return PreferencesManager.storeMgr.getInteger(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_EDITOR_LAYOUT_ID),
        ...
        public static boolean getEditorShowAllObjects() {
                return PreferencesManager.storeMgr
                                .getBoolean(
                                                GlobalLoader.loadUntranslated(
                                                                UntranslatedString.PREFS_KEY_EDITOR_SHOW_ALL),
                                                true);
        }
        ...
        public static int getLanguageID() {
                return PreferencesManager.storeMgr.getInteger(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_LANGUAGE_ID),
        ...
        public static String getLastDirOpen() {
                return PreferencesManager.storeMgr.getString(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_LAST_DIR_OPEN),
        ...
        public static String getLastDirSave() {
                return PreferencesManager.storeMgr.getString(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_LAST_DIR_SAVE),
                                StringLoader.loadCommon(CommonString.EMPTY));
        }
        ...
        public static boolean getMusicEnabled() {
                return PreferencesManager.storeMgr
                                .getBoolean(
                                                GlobalLoader.loadUntranslated(
                                                                UntranslatedString.PREFS_KEY_ENABLE_MUSIC),
                                                true);
        }

        private static String getPrefsDirectory() {
                final String osName = System.getProperty(
                                GlobalLoader.loadUntranslated(UntranslatedString.OS_NAME));
                if (osName.indexOf(GlobalLoader
                                .loadUntranslated(UntranslatedString.MAC_OS_X)) != -1) {
                        // Mac OS X
                        return GlobalLoader
                                        .loadUntranslated(UntranslatedString.DIRECTORY_PREFS_MAC);
                } else if (osName.indexOf(GlobalLoader
                                .loadUntranslated(UntranslatedString.WINDOWS)) != -1) {
                        // Windows
                        return GlobalLoader.loadUntranslated(
                                        UntranslatedString.DIRECTORY_PREFS_WINDOWS);
                } else {
                        // Other - assume UNIX-like
                        return GlobalLoader
                                        .loadUntranslated(UntranslatedString.DIRECTORY_PREFS_UNIX);
                }
        }
        ...
        private static String getPrefsDirPrefix() {
                ...
                if (osName.indexOf(GlobalLoader
                                .loadUntranslated(UntranslatedString.MAC_OS_X)) != -1) {
                        // Mac OS X
                        return System.getenv(GlobalLoader
                                        .loadUntranslated(UntranslatedString.DIRECTORY_UNIX_HOME));
                } else if (osName.indexOf(GlobalLoader
                                .loadUntranslated(UntranslatedString.WINDOWS)) != -1) {
                        // Windows
                        return System.getenv(GlobalLoader.loadUntranslated(
                                        UntranslatedString.DIRECTORY_WINDOWS_APPDATA));
                } else {
                        // Other - assume UNIX-like
                        return System.getenv(GlobalLoader
                                        .loadUntranslated(UntranslatedString.DIRECTORY_UNIX_HOME));
        ...
        private static String getPrefsFileExtension() {
                return StringLoader.loadCommon(CommonString.NOTL_PERIOD)
                                + Extension.getPreferencesExtension();
        }
        ...
        private static String getPrefsFileName() {
                ...
                if (osName.indexOf(GlobalLoader
                        ...
                        // Mac OS X
                        return GlobalLoader
                                        .loadUntranslated(UntranslatedString.FILE_PREFS_MAC);
                } else if (osName.indexOf(GlobalLoader
                                .loadUntranslated(UntranslatedString.WINDOWS)) != -1) {
                        // Windows
                        return GlobalLoader
                                        .loadUntranslated(UntranslatedString.FILE_PREFS_WINDOWS);
                } else {
                        // Other - assume UNIX-like
                        return GlobalLoader
                                        .loadUntranslated(UntranslatedString.FILE_PREFS_UNIX);
                }
        }
        ...
        public static boolean getSoundsEnabled() {
                return PreferencesManager.storeMgr
                                .getBoolean(
                                                GlobalLoader.loadUntranslated(
                                                                UntranslatedString.PREFS_KEY_ENABLE_SOUNDS),
                                                true);
        }
        ...
        public static boolean isDeadlyDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_ENABLE_DIFFICULTY_DEADLY),
                                true);
        }
        ...
        public static boolean isEasyDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_ENABLE_DIFFICULTY_EASY),
                                true);
        }
        ...
        public static boolean isHardDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_ENABLE_DIFFICULTY_HARD),
                                true);
        }
        ...
        public static boolean isKidsDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_ENABLE_DIFFICULTY_KIDS),
                                true);
        }
        ...
        public static boolean isMediumDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(
                                GlobalLoader.loadUntranslated(
                                                UntranslatedString.PREFS_KEY_ENABLE_DIFFICULTY_MEDIUM),
                                true);
        }

        public static boolean oneMove() {
                return PreferencesManager.storeMgr.getBoolean(GlobalLoader
                                .loadUntranslated(UntranslatedString.PREFS_KEY_ONE_MOVE), true);
        }
        ...
        public static void readPrefs() {
                try (BufferedInputStream buf = new BufferedInputStream(
                        ...
                        PreferencesManager.storeMgr.setBoolean(
                                        GlobalLoader.loadUntranslated(
                                                        UntranslatedString.PREFS_KEY_UPDATES_STARTUP),
                                        true);
                        PreferencesManager.storeMgr
                                        .setBoolean(
                                                        GlobalLoader.loadUntranslated(
                                                                        UntranslatedString.PREFS_KEY_ONE_MOVE),
                                                        true);
                        PreferencesManager.storeMgr
                                        .setBoolean(
                                                        GlobalLoader.loadUntranslated(
                        ...
                        PreferencesManager.storeMgr
                                        .setInteger(
                                                        GlobalLoader.loadUntranslated(
                                                                        UntranslatedString.PREFS_KEY_ACTION_DELAY),
                                                        2);
                        PreferencesManager.storeMgr
                                        .setBoolean(
                                                        GlobalLoader.loadUntranslated(
                                                                        UntranslatedString.PREFS_KEY_CLASSIC_ACCEL),
                                                        false);
        ...
        static void setActionDelay(final int value) {
                PreferencesManager.storeMgr.setInteger(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_ACTION_DELAY), value);
        }

        static void setCheckUpdatesAtStartup(final boolean value) {
                PreferencesManager.storeMgr.setBoolean(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_UPDATES_STARTUP), value);
        }

        public static void setClassicAccelerators(final boolean value) {
                PreferencesManager.storeMgr.setBoolean(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_CLASSIC_ACCEL), value);
        }
        ...
        public static void setLanguageID(final int value) {
                ...
                PreferencesManager.storeMgr.setInteger(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_LANGUAGE_ID), value);
                if (oldValue != value) {
        ...
        public static void setLastDirOpen(final String value) {
                PreferencesManager.storeMgr.setString(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_LAST_DIR_OPEN), value);
        }

        public static void setLastDirSave(final String value) {
                PreferencesManager.storeMgr.setString(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_LAST_DIR_SAVE), value);
        }
        ...
        static void setMusicEnabled(final boolean status) {
                PreferencesManager.storeMgr.setBoolean(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_ENABLE_MUSIC), status);
        }

        static void setOneMove(final boolean value) {
                PreferencesManager.storeMgr.setBoolean(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_ONE_MOVE), value);
        }

        static void setSoundsEnabled(final boolean status) {
                PreferencesManager.storeMgr.setBoolean(GlobalLoader.loadUntranslated(
                                UntranslatedString.PREFS_KEY_ENABLE_SOUNDS), status);
        }
