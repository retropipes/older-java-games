...
public class XMLFileReader implements AutoCloseable {
    ...
    public XMLFileReader(final InputStream stream, final String newDocTag)
            throws IOException {
    ...
    // Constructors
    public XMLFileReader(final String filename, final String newDocTag)
            throws IOException {
    ...
    public boolean readBoolean() throws IOException {
        ...
        if (line != null) {
            ...
            XMLFileReader.validateOpeningTag(split[0],
                    XMLFileConstants.BOOLEAN_TAG);
            XMLFileReader.validateClosingTag(split[2],
                    XMLFileConstants.BOOLEAN_TAG);
