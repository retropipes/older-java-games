...
public class PreferencesManager {
        ...
        public static boolean getEditorShowAllObjects() {
                return PreferencesManager.storeMgr.getBoolean(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_EDITOR_SHOW_ALL),
                                true);
        }
        ...
        public static boolean useClassicAccelerators() {
                return PreferencesManager.storeMgr.getBoolean(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_CLASSIC_ACCEL),
                                false);
        }
        ...
        public static String getLastDirOpen() {
                return PreferencesManager.storeMgr.getString(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_LAST_DIR_OPEN),
                                StringConstants.COMMON_STRING_EMPTY);
        }
        ...
        public static String getLastDirSave() {
                return PreferencesManager.storeMgr.getString(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_LAST_DIR_SAVE),
                                StringConstants.COMMON_STRING_EMPTY);
        }
        ...
        public static boolean shouldCheckUpdatesAtStartup() {
                return PreferencesManager.storeMgr.getBoolean(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_UPDATES_STARTUP),
                                true);
        }
        ...
        static int getActionDelay() {
                return PreferencesManager.storeMgr.getInteger(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_ACTION_DELAY),
                                2);
        }
        ...
        public static boolean oneMove() {
                return PreferencesManager.storeMgr.getBoolean(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_ONE_MOVE),
                                true);
        }
        ...
        public static boolean enableAnimation() {
                return PreferencesManager.storeMgr.getBoolean(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_ANIMATION),
                                true);
        }
        ...
        public static boolean isKidsDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(StringLoader.loadString(
                                StringConstants.NOTL_STRINGS_FILE,
                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_DIFFICULTY_KIDS),
                                true);
        }

        public static void setKidsDifficultyEnabled(final boolean value) {
                PreferencesManager.storeMgr.setBoolean(StringLoader.loadString(
                                StringConstants.NOTL_STRINGS_FILE,
                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_DIFFICULTY_KIDS),
                                value);
        }
        ...
        public static boolean isEasyDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(StringLoader.loadString(
                                StringConstants.NOTL_STRINGS_FILE,
                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_DIFFICULTY_EASY),
                                true);
        }
        ...
        public static boolean isMediumDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(StringLoader.loadString(
                                StringConstants.NOTL_STRINGS_FILE,
                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_DIFFICULTY_MEDIUM),
                                true);
        }
        ...
        public static boolean isHardDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(StringLoader.loadString(
                                StringConstants.NOTL_STRINGS_FILE,
                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_DIFFICULTY_HARD),
                                true);
        }
        ...
        public static boolean isDeadlyDifficultyEnabled() {
                return PreferencesManager.storeMgr.getBoolean(StringLoader.loadString(
                                StringConstants.NOTL_STRINGS_FILE,
                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_DIFFICULTY_DEADLY),
                                true);
        }
        ...
        public static boolean getSoundsEnabled() {
                return PreferencesManager.storeMgr.getBoolean(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_SOUNDS),
                                true);
        }
        ...
        public static boolean getMusicEnabled() {
                return PreferencesManager.storeMgr.getBoolean(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_PREFS_KEY_ENABLE_MUSIC),
                                true);
        }
        ...
        private static String getPrefsDirPrefix() {
                ...
                if (osName.indexOf(
                        ...
                        // Windows
                        return System.getenv(StringLoader.loadString(
                                        StringConstants.NOTL_STRINGS_FILE,
        ...
        private static String getPrefsFileExtension() {
                return StringConstants.COMMON_STRING_NOTL_PERIOD
        ...
        public static void readPrefs() {
                try (BufferedInputStream buf = new BufferedInputStream(
                        ...
                        PreferencesManager.storeMgr.setString(StringLoader.loadString(
                                        StringConstants.NOTL_STRINGS_FILE,
                                        StringConstants.NOTL_STRING_PREFS_KEY_LAST_DIR_OPEN),
                                        StringConstants.COMMON_STRING_EMPTY);
                        PreferencesManager.storeMgr.setString(StringLoader.loadString(
                        ...
                        PreferencesManager.storeMgr.setInteger(
                                        StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                        StringConstants.NOTL_STRING_PREFS_KEY_LANGUAGE_ID),
                                        PreferencesManager.FALLBACK_LANGUAGE_ID);
                        PreferencesManager.storeMgr.setInteger(StringLoader.loadString(
                                        StringConstants.NOTL_STRINGS_FILE,
                                        StringConstants.NOTL_STRING_PREFS_KEY_EDITOR_LAYOUT_ID),
                                        PreferencesManager.DEFAULT_EDITOR_LAYOUT_ID);
                        PreferencesManager.storeMgr.setBoolean(StringLoader.loadString(
