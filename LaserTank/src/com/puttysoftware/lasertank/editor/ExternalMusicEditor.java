...
public class ExternalMusicEditor extends GenericObjectEditor {
    ...
    public ExternalMusicEditor() {
        super(StringLoader.loadString(StringConstants.EDITOR_STRINGS_FILE,
                StringConstants.EDITOR_STRING_MUSIC_EDITOR), 2, 5, 1, true);
    ...
    protected boolean newObjectOptions() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Importer.showImporter(ExternalMusicEditor.this.getOutputFrame(),
                        app.getMenuManager().getMainMenuBar());
    ...
    protected void guiActionButtonProperties(final JButton actBtn,
        ...
        if (actBtn != null) {
            if (col == 0) {
                actBtn.setText(StringLoader.loadString(
