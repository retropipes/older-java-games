...
final class MovingLaserTracker {
    ...
    void activateLasers(final int zx, final int zy, final int zox,
        ...
        if (this.lt == LaserTypeConstants.LASER_TYPE_GREEN) {
            ...
            GameManager.updateUndo(true, false, false, false, false, false,
            ...
            LaserTank.getApplication().getArenaManager().setDirty(true);
            GameManager.updateUndo(false, true, false, false, false, false,
                    false, false, false, false);
            ...
            LaserTank.getApplication().getArenaManager().setDirty(true);
            GameManager.updateUndo(false, false, true, false, false, false,
                    false, false, false, false);
            ...
            LaserTank.getApplication().getArenaManager().setDirty(true);
            GameManager.updateUndo(false, false, false, false, false, true,
                    false, false, false, false);
        ...
        if (this.laser) {
            ...
            try {
                LaserTank.getApplication().getArenaManager().getArena()
                        .setVirtualCell(new Empty(),
                                this.ox + this.cumX - this.incX,
                                this.oy + this.cumY - this.incY, pz,
                                this.l.getLayer());
                gm.redrawArena();
    ...
    private void doLasersOnce(final boolean tracking) {
        ...
        try {
            lol = m.getCell(this.ox + this.cumX, this.oy + this.cumY, pz,
                    ArenaConstants.LAYER_LOWER_OBJECTS);
            lou = m.getCell(this.ox + this.cumX, this.oy + this.cumY, pz,
        ...
        if (this.res) {
            ...
            if (this.lt == LaserTypeConstants.LASER_TYPE_MISSILE) {
                final Direction suffix = DirectionResolver
                        .resolveRelativeDirection(this.incX, this.incY);
                ...
                final Direction suffix = DirectionResolver
                        .resolveRelativeDirectionHV(this.incX, this.incY);
                this.l.setDirection(suffix);
            }
            ...
            try {
                if (lol.doLasersPassThrough() && lou.doLasersPassThrough()) {
                    m.setVirtualCell(this.l, this.ox + this.cumX,
            ...
            try {
                m.setVirtualCell(new Empty(), this.ox + this.cumX - this.incX,
            ...
            final boolean laserKill = this.ox + this.cumX == px
                    && this.oy + this.cumY == py;
            if (laserKill) {
                gm.gameOver();
                return;
            }
            Direction dir = lou.laserEnteredAction(this.ox + this.cumX,
                    this.oy + this.cumY, pz, this.incX, this.incY, this.lt,
                    this.l.getForceUnitsImbued());
            if (dir != Direction.NONE) {
                dir = lol.laserEnteredAction(this.ox + this.cumX,
                        this.oy + this.cumY, pz, this.incX, this.incY, this.lt,
                        this.l.getForceUnitsImbued());
            }
            if (dir == Direction.NONE) {
                ...
                try {
                    m.setVirtualCell(new Empty(), this.ox + this.cumX,
                            this.oy + this.cumY, pz, this.l.getLayer());
                } catch (final ArrayIndexOutOfBoundsException aioobe) {
                    // Ignore
                }
            ...
            this.incX = resX;
            this.incY = resY;
            dir = lou.laserExitedAction(oldincX, oldincY, pz, this.incX,
                    this.incY, this.lt);
            if (dir != Direction.NONE) {
                dir = lol.laserExitedAction(oldincX, oldincY, pz, this.incX,
                        this.incY, this.lt);
            }
            if (dir == Direction.NONE) {
                this.res = false;
            ...
            if (m.isVerticalWraparoundEnabled()) {
                this.cumX = MovingLaserTracker.normalizeColumn(
                        this.cumX + this.incX, AbstractArena.getMinColumns());
            } else {
                this.cumX += this.incX;
            }
            if (m.isHorizontalWraparoundEnabled()) {
                this.cumY = MovingLaserTracker.normalizeRow(
                        this.cumY + this.incY, AbstractArena.getMinRows());
            } else {
                this.cumY += this.incY;
            }
            if (oldLaserDir != laserDir && tracking) {
                try {
                    m.setVirtualCell(new Empty(),
                            this.ox + this.cumX - this.incX,
                            this.oy + this.cumY - this.incY, pz,
                            this.l.getLayer());
                } catch (final ArrayIndexOutOfBoundsException aioobe) {
                ...
                if (m.isHorizontalWraparoundEnabled()) {
                    this.cumY = MovingLaserTracker.normalizeColumn(
                            this.cumY + this.incY,
                            AbstractArena.getMinColumns());
                } else {
                    this.cumY += this.incY;
