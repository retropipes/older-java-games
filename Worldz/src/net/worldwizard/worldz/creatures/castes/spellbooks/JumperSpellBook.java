package net.worldwizard.worldz.creatures.castes.spellbooks;

import net.worldwizard.worldz.creatures.StatConstants;
import net.worldwizard.worldz.effects.DamageEffect;
import net.worldwizard.worldz.effects.DrainEffect;
import net.worldwizard.worldz.effects.Effect;
import net.worldwizard.worldz.effects.HealingEffect;
import net.worldwizard.worldz.effects.RegeneratingEffect;
