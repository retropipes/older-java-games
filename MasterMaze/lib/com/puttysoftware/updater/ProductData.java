...
public class ProductData {
    ...
    public static final int CODE_MATURE_RELEASE = 5;
    public static final int CODE_LONG_TERM_RELEASE = 6;
    ...
    public ProductData(final String update, final String blurb,
        ...
        if (code == ProductData.CODE_PRE_ALPHA) {
            ...
            rt = "rc_";
        } else if (code == ProductData.CODE_STABLE_RELEASE) {
            rt = "stable_";
        } else if (code == ProductData.CODE_MATURE_RELEASE) {
            rt = "mature_";
        } else {
            rt = "longterm_";
        }
