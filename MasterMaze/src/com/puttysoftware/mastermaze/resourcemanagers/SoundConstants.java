...
public class SoundConstants {
    ...
    public static final int SOUND_INTO_PIT = 41;
    public static final int SOUND_LEVEL_UP = 42;
    public static final int SOUND_LIGHT = 43;
    ...
    public static final int SOUND_ON_WHO = 49;
    public static final int SOUND_OW = 50;
    public static final int SOUND_PLAYER_UP = 52;
    public static final int SOUND_PUSH_PULL = 53;
    public static final int SOUND_SHATTER = 54;
    public static final int SOUND_SHOP = 55;
    public static final int SOUND_SINK_BLOCK = 56;
    public static final int SOUND_SLIME = 57;
    public static final int SOUND_SPECIAL = 58;
    public static final int SOUND_SPELL = 59;
    public static final int SOUND_SPRINGBOARD = 60;
    public static final int SOUND_SUN_STONE = 63;
    ...
    public static final int SOUND_WALK_LAVA = 74;
    public static final int SOUND_WALK_SLIME = 75;
    public static final int SOUND_WALK_WATER = 76;
    public static final int SOUND_WATER = 77;
    public static final int SOUND_WEAKNESS = 78;
    public static final int SOUND_HURT = 80;
    public static final int SOUND_WALL_TRAP = 81;
    ...
    static final String[] SOUND_NAMES = { "action_failed", "arrow",
            ...
            "hit", "identify", "into_pit", "level_up", "light", "loading",
            "logo", "low_health", "missed", "next_round", "on_who", "ow",
            "pick_lock", "player_up", "push_pull", "shatter", "shop",
            ...
            "walk_lava", "walk_slime", "walk_water", "water", "weakness",
            "win_game", "hurt", "wall_trap" };
