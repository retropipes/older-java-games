...
import com.puttysoftware.mastermaze.creatures.characterfiles.CharacterRegistration;
...
import com.puttysoftware.mastermaze.game.InventoryViewer;
import com.puttysoftware.mastermaze.game.NoteManager;
import com.puttysoftware.mastermaze.game.PrestigeViewer;
import com.puttysoftware.mastermaze.game.StatisticsViewer;
...
public class MenuManager {
    ...
    public void setGameMenus() {
        ...
        final ArrayList<GenericEditor> allEditors = MasterMaze.getApplication()
                .getAllEditors();
    ...
    private void createMenus() {
        ...
        this.helpAbout = new JMenuItem("About MasterMaze...");
        this.helpObjectHelp = new JMenuItem("MasterMaze Object Help");
    ...
    private class EventHandler implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            try {
                ...
                final Application app = MasterMaze.getApplication();
                final GenericBattle ba = app.getBattle();
                ...
                if (cmd.equals("New...")) {
                    ...
                    ba.endTurn();
                } else if (cmd.equals("About MasterMaze...")) {
                    app.getAboutDialog().showAboutDialog();
                } else if (cmd.equals("MasterMaze Object Help")) {
