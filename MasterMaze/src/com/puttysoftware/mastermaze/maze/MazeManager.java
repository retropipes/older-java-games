...
import com.puttysoftware.mastermaze.maze.games.GameFinder;
import com.puttysoftware.mastermaze.maze.games.GameLoadTask;
...
public class MazeManager {
    ...
    private static final String MAC_DIR = "/Library/Application Support/Putty Software/MasterMaze/Games/";
    private static final String WIN_DIR = "\\Putty Software\\MasterMaze\\Games\\";
    private static final String UNIX_DIR = "/.puttysoftware/mastermaze/games/";
    ...
    public void handleDeferredSuccess(final boolean value) {
        ...
        this.setDirty(false);
        MasterMaze.getApplication().getGameManager().stateChanged();
        MasterMaze.getApplication().getEditor().mazeChanged();
        MasterMaze.getApplication().getMenuManager().checkFlags();
    }
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (extension.equals(Extension.getGameExtension())) {
                    ...
                    try {
                        ...
                        MasterMaze.getErrorLogger().logError(ioe);
                    }
                    MazeManager.loadFile(filename, false, true);
                } else {
                    CommonDialogs.showDialog(
    ...
    private static void saveFile(final String filename,
        ...
        MasterMaze.getApplication().showMessage("Saving " + sg + " file...");
        if (locked) {
