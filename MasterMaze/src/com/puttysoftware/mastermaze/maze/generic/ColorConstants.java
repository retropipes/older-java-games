...
public interface ColorConstants {
    ...
    public static final int COLOR_DARK_BLUE = new Color(0, 0, 127).getRGB();
    public static final int COLOR_DARK_CYAN = new Color(0, 127, 127).getRGB();
    public static final int COLOR_DARK_GREEN = new Color(0, 127, 0).getRGB();
    public static final int COLOR_DARK_MAGENTA = new Color(127, 0, 127)
            .getRGB();
    public static final int COLOR_DARK_PURPLE = new Color(63, 0, 127).getRGB();
    public static final int COLOR_DARK_RED = new Color(127, 0, 0).getRGB();
    public static final int COLOR_DARK_GRAY = new Color(63, 63, 63).getRGB();
    public static final int COLOR_DARK_YELLOW = new Color(127, 127, 0).getRGB();
    public static final int COLOR_DARK_SKY = new Color(0, 63, 127).getRGB();
    public static final int COLOR_LIGHT_BLUE = new Color(127, 127, 255)
            .getRGB();
    public static final int COLOR_LIGHT_CYAN = new Color(127, 255, 255)
            .getRGB();
    public static final int COLOR_LIGHT_GREEN = new Color(127, 255, 127)
            .getRGB();
    public static final int COLOR_LIGHT_MAGENTA = new Color(255, 127, 255)
            .getRGB();
    public static final int COLOR_LIGHT_PURPLE = new Color(191, 127, 255)
            .getRGB();
    public static final int COLOR_LIGHT_RED = new Color(255, 127, 127).getRGB();
    public static final int COLOR_LIGHT_GRAY = new Color(191, 191, 191)
            .getRGB();
    public static final int COLOR_LIGHT_YELLOW = new Color(255, 255, 127)
            .getRGB();
    ...
    public static final int COLOR_PLANT = new Color(0, 255, 127).getRGB();
    ...
    public static final int COLOR_BRIDGE = new Color(191, 95, 49).getRGB();
    ...
    public static final int COLOR_SUNKEN_BLOCK = new Color(95, 0, 0).getRGB();
    ...
    public static final int COLOR_ICE = new Color(223, 239, 255).getRGB();
}
