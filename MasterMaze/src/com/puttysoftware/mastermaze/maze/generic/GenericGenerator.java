...
import com.puttysoftware.mastermaze.maze.objects.HorizontalBarrier;
import com.puttysoftware.mastermaze.maze.objects.VerticalBarrier;
...
public abstract class GenericGenerator extends GenericWall {
    ...
    // Constructors
    protected GenericGenerator(final int tc) {
        super(tc);
