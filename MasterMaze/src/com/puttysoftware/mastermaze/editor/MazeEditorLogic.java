 ...
 */
package com.puttysoftware.mastermaze.editor;
...
import com.puttysoftware.mastermaze.maze.objects.BlockTeleport;
import com.puttysoftware.mastermaze.maze.objects.ChainTeleport;
import com.puttysoftware.mastermaze.maze.objects.Destination;
...
import com.puttysoftware.mastermaze.maze.objects.InvisibleBlockTeleport;
import com.puttysoftware.mastermaze.maze.objects.InvisibleChainTeleport;
import com.puttysoftware.mastermaze.maze.objects.InvisibleOneShotChainTeleport;
import com.puttysoftware.mastermaze.maze.objects.InvisibleOneShotTeleport;
import com.puttysoftware.mastermaze.maze.objects.InvisibleTeleport;
import com.puttysoftware.mastermaze.maze.objects.MetalButton;
import com.puttysoftware.mastermaze.maze.objects.MovingFinish;
import com.puttysoftware.mastermaze.maze.objects.OneShotChainTeleport;
import com.puttysoftware.mastermaze.maze.objects.OneShotTeleport;
import com.puttysoftware.mastermaze.maze.objects.RandomInvisibleOneShotTeleport;
import com.puttysoftware.mastermaze.maze.objects.RandomInvisibleTeleport;
import com.puttysoftware.mastermaze.maze.objects.RandomOneShotTeleport;
import com.puttysoftware.mastermaze.maze.objects.RandomTeleport;
import com.puttysoftware.mastermaze.maze.objects.StairsDown;
import com.puttysoftware.mastermaze.maze.objects.StairsUp;
import com.puttysoftware.mastermaze.maze.objects.Teleport;
import com.puttysoftware.mastermaze.maze.objects.TreasureChest;
import com.puttysoftware.mastermaze.maze.objects.TwoWayTeleport;
...
public class MazeEditorLogic {
    ...
    public void editConditionalTeleportDestination(
        ...
        final String choice = CommonDialogs.showInputDialog("Edit What?",
                "Editor", MazeEditorLogic.choices, MazeEditorLogic.choices[0]);
        if (choice != null) {
            this.instanceBeingEdited = instance;
            this.conditionalEditFlag = 0;
            for (int x = 0; x < MazeEditorLogic.choices.length; x++) {
                if (MazeEditorLogic.choices[x].equals(choice)) {
    ...
    public MazeObject editTreasureChestContents() {
        MasterMaze.getApplication().showMessage("Pick treasure chest contents");
    ...
    public void editFinishToDestination(final GenericTeleportTo ft) {
        String input1 = null;
        int destW = 0;
    ...
    public void setTeleportDestination(final int x, final int y) {
        ...
        this.meg.swapFromTeleportHandler();
        this.checkMenus();
        MasterMaze.getApplication().showMessage("Destination set.");
        app.getMazeManager().setDirty(true);
        this.redrawEditor();
    }
    ...
    public void editPlayerLocation() {
        ...
        MasterMaze.getApplication().showMessage("Click to set start point");
    }
    ...
    public void fillLevelRandomly() {
        if (this.confirmNonUndoable(
            ...
            MasterMaze.getApplication().showMessage("Level randomly filled.");
            MasterMaze.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
    ...
    public void fillFloorRandomly() {
        if (this.confirmNonUndoable(
            ...
            MasterMaze.getApplication().showMessage("Floor randomly filled.");
            MasterMaze.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
        ...
        if (this.confirmNonUndoable(
            ...
            MasterMaze.getApplication().getMazeManager().getMaze()
                    .fillFloorAndLayer(
                            this.getLocationManager().getEditorLocationZ(),
                            this.getLocationManager().getEditorLocationE());
            MasterMaze.getApplication().showMessage("Floor and layer filled.");
            MasterMaze.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
    ...
    public void exitEditor() {
        ...
        gm.stateChanged();
        MasterMaze.getApplication().getGUIManager().showGUI();
    }
    ...
    public void undo() {
        ...
        if (x != -1 && y != -1 && z != -1 && w != -1) {
            ...
            MasterMaze.getApplication().showMessage("Nothing to undo");
        }
    }
    ...
    public void redo() {
        ...
        if (x != -1 && y != -1 && z != -1 && w != -1) {
            ...
            MasterMaze.getApplication().showMessage("Nothing to redo");
        }
    }
