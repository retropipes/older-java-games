...
class MazeEditorGUI {
    ...
    MazeEditorGUI() {
        ...
        this.treasurePicker
                .updatePickerLayout(ImageTransformer.MAX_WINDOW_SIZE);
    ...
    void updateEditorLevelAbsolute(final int w, final UndoRedoEngine engine) {
        this.elMgr.setEditorLocationW(w);
        // Level Change
        MasterMaze.getApplication().getMazeManager().getMaze().switchLevel(w);
        this.fixLimits();
        this.setUpGUI();
        this.checkMenus(engine);
        this.redrawEditor();
        ...
        for (x = this.evMgr.getViewingWindowLocationX(); x <= this.evMgr
            ...
            for (y = this.evMgr.getViewingWindowLocationY(); y <= this.evMgr
                ...
                try {
                    ...
                    if (u == y && v == x) {
                        final MazeObject obj3 = new Player().editorRenderHook(y,
    ...
    void redrawVirtual(final int x, final int y, final MazeObject obj3) {
        // Draw the square
        final Application app = MasterMaze.getApplication();
        int xFix, yFix;
        ...
        try {
            ...
            final MazeObject obj4 = obj3.editorRenderHook(y, x,
                    this.elMgr.getEditorLocationZ());
    ...
    void handleCloseWindow() {
        try {
            final MazeEditorLogic mel = MasterMaze.getApplication().getEditor();
            final Application app = MasterMaze.getApplication();
    ...
    private class EventHandler implements AdjustmentListener, MouseListener,
        ...
        public void adjustmentValueChanged(final AdjustmentEvent e) {
            try {
                ...
                final MazeEditorLogic mel = MasterMaze.getApplication()
                        .getEditor();
        ...
        public void windowClosing(final WindowEvent we) {
            MazeEditorGUI.this.handleCloseWindow();
        }
