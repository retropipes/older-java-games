 ...
 */
package com.puttysoftware.mastermaze.editor.namer.editor;
...
import com.puttysoftware.mastermaze.editor.namer.generic.GenericObjectEditor;
...
public class NameEditor extends GenericObjectEditor {
    ...
    protected void loadObject() {
        this.cachedNames = MasterMaze.getApplication().getScenarioManager()
                .getNamesFileManager().getNames();
    }

    @Override
    protected void saveObject() {
        MasterMaze.getApplication().getScenarioManager().getNamesFileManager()
            ...
            try {
                ...
                if (cmd.equals("Edit Names")) {
                    ...
                    if (me.doesObjectExist()) {
                        ...
                        me.create();
                        MasterMaze.getApplication().getScenarioManager()
