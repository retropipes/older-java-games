...
public class NamesDataManager {
	...
	private static final String MAC_DIR = "/Library/Application Support/Putty Software/MasterMaze/";
	...
	private static String[] getNamesDefaultData() {
		try {
			final ResourceStreamReader rsr = new ResourceStreamReader(NamesDataManager.class
