...
import com.puttysoftware.mastermaze.creatures.castes.Caste;
import com.puttysoftware.mastermaze.creatures.castes.CasteManager;
import com.puttysoftware.mastermaze.creatures.characterfiles.CharacterLoader;
...
import com.puttysoftware.mastermaze.creatures.genders.Gender;
import com.puttysoftware.mastermaze.creatures.genders.GenderManager;
import com.puttysoftware.mastermaze.creatures.personalities.Personality;
import com.puttysoftware.mastermaze.creatures.personalities.PersonalityManager;
import com.puttysoftware.mastermaze.creatures.races.Race;
...
public class PartyManager {
    ...
    public static boolean createParty(final JFrame owner) {
        ...
        if (PreferencesManager.getRPGEnabled()) {
            ...
            PartyManager.party.addPartyMember(new NoRPGPartyMember());
            return true;
        }
    }
