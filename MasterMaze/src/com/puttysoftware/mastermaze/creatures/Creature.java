...
public abstract class Creature {
    ...
    private MapAIRoutine mapAI;
    private WindowAIRoutine windowAI;
    ...
    public final MapAIRoutine getMapAI() {
        return this.mapAI;
    }

    public WindowAIRoutine getWindowAI() {
    ...
    public final void setMapAI(final MapAIRoutine newAI) {
        this.mapAI = newAI;
    }

    public final void setWindowAI(final WindowAIRoutine newAI) {
        this.windowAI = newAI;
    }
