...
public abstract class GenericChainTeleportDown extends GenericTeleportDown {
    // Constructors
    protected GenericChainTeleportDown() {
        super();
    }

    protected GenericChainTeleportDown(final boolean doesAcceptPushInto) {
