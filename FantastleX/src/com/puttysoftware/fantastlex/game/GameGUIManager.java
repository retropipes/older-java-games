...
import com.puttysoftware.fantastlex.maze.objects.Darkness;
import com.puttysoftware.fantastlex.maze.objects.EmptyVoid;
import com.puttysoftware.fantastlex.maze.objects.MazeNoteObject;
...
class GameGUIManager {
    ...
    void initViewManager() {
        if (this.vwMgr == null) {
            this.vwMgr = FantastleX.getApplication().getGameManager()
                    .getViewManager();
            this.setUpGUI();
        }
    }
    ...
    private void setUpGUI() {
        ...
        this.outputFrame = new JFrame("FantastleX");
    ...
    private class EventHandler
        ...
        public void keyPressed(final KeyEvent e) {
            final GameLogicManager glm = FantastleX.getApplication()
                    .getGameManager();
