 ...
 */
package com.puttysoftware.fantastlex.creatures.races;

import java.io.IOException;
import java.util.ArrayList;

import com.puttysoftware.fantastlex.datamanagers.RaceDataManager;
        ...
        if (!RaceConstants.INITED) {
            try (final ResourceStreamReader rsr = new ResourceStreamReader(
                    RaceDataManager.class
                            .getResourceAsStream("/com/puttysoftware/fantastlex/resources/data/race/catalog.txt"))) {
                // Fetch data
