...
class MazeEditorGUI {
    ...
    void updateEditorLevelAbsolute(final int w, final UndoRedoEngine engine) {
        this.elMgr.setEditorLocationW(w);
        // Level Change
        FantastleX.getApplication().getMazeManager().getMaze().switchLevel(w);
        this.fixLimits();
        this.setUpGUI();
        this.checkMenus(engine);
        this.redrawEditor();
    ...
    void handleCloseWindow() {
        try {
            final MazeEditorLogic mel = FantastleX.getApplication().getEditor();
            final Application app = FantastleX.getApplication();
    ...
    private class EventHandler implements AdjustmentListener, MouseListener,
        ...
        public void adjustmentValueChanged(final AdjustmentEvent e) {
            try {
                ...
                final MazeEditorLogic mel = FantastleX.getApplication()
                        .getEditor();
