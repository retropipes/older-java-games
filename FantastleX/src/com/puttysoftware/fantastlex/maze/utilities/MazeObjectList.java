...
public class MazeObjectList {
    ...
    public AbstractMazeObject[] getAllBows() {
        ...
        final AbstractMazeObject[] allUsableObjects = new AbstractMazeObject[objectCount + 1];
        objectCount = 0;
    ...
    public final AbstractMazeObject[] getAllNotRequiredInBattle(final int layer) {
        final AbstractMazeObject[] objs = this.getAllObjects();
