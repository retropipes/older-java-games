...
import com.puttysoftware.fantastlex.maze.games.GameFilter;
import com.puttysoftware.fantastlex.maze.games.GameFinder;
...
public class MazeManager {
    ...
    private static final String MAC_DIR = "/Library/Application Support/Putty Software/FantastleX/Games/";
    private static final String WIN_DIR = "\\Putty Software\\FantastleX\\Games\\";
    private static final String UNIX_DIR = "/.puttysoftware/fantastlex/games/";
    ...
    public void handleDeferredSuccess(final boolean value) {
        ...
        this.setDirty(false);
        FantastleX.getApplication().getGameManager().stateChanged();
        FantastleX.getApplication().getEditor().mazeChanged();
        FantastleX.getApplication().getMenuManager().checkFlags();
    }
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (extension.equals(Extension.getGameExtension())) {
                    ...
                    try {
                        ...
                        FantastleX.getErrorLogger().logError(ioe);
                    }
                    MazeManager.loadFile(filename, false, true);
                } else {
                    CommonDialogs.showDialog(
    ...
    private static void saveFile(final String filename,
        ...
        FantastleX.getApplication().showMessage("Saving " + sg + " file...");
        if (locked) {
