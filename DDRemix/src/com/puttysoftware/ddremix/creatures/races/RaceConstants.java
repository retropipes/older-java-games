 ...
 */
package com.puttysoftware.ddremix.creatures.races;
        ...
        if (!RaceConstants.INITED) {
            try (final ResourceStreamReader rsr = new ResourceStreamReader(
                    RaceDataManager.class
                            .getResourceAsStream("/com/puttysoftware/ddremix/resources/data/race/catalog.txt"))) {
                // Fetch data
                ...
                DDRemix.getErrorLogger().logError(ioe);
            }
        }
    }
}
