...
public final class MazeManager {
    ...
    private static final String MAC_DIR = "/Library/Application Support/Putty Software/DDRemix/Games/";
    private static final String WIN_DIR = "\\Putty Software\\DDRemix\\Games\\";
    private static final String UNIX_DIR = "/.puttysoftware/ddremix/games/";
    ...
    public void handleDeferredSuccess(final boolean value,
        ...
        this.setDirty(false);
        DDRemix.getApplication().getGameManager().stateChanged();
        DDRemix.getApplication().getMenuManager().checkFlags();
    }
            ...
            if (returnVal != null) {
                ...
                if (!FilenameChecker.isFilenameOK(returnVal)) {
                    ...
                    if (!file.getParentFile().exists()) {
                        ...
                        if (!okay) {
                            DDRemix.getErrorLogger().logError(new IOException(
    ...
    private static void saveFile(final String filename) {
        ...
        DDRemix.getApplication().showMessage("Saving " + sg + " file...");
