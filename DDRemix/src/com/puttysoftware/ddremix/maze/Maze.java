...
public class Maze {
    // Properties
    private LayeredDungeon mazeData;
    private int startW;
    private int locW;
    private int saveW;
    ...
    public Maze() {
        ...
        this.basePath = System.getProperty("java.io.tmpdir") + File.separator
                + "DDRemix" + File.separator + randomID + ".maze";
        final File base = new File(this.basePath);
        final boolean success = base.mkdirs();
        if (!success) {
            CommonDialogs.showErrorDialog(
                    "Maze temporary folder creation failed!", "DDRemix");
        }
    }
    ...
    public static int getMaxFloors() {
        return LayeredDungeon.getMaxFloors();
    }

    public static int getMaxColumns() {
        return LayeredDungeon.getMaxColumns();
    }

    public static int getMaxRows() {
        return LayeredDungeon.getMaxRows();
    }
    ...
    public boolean addLevel(final int rows, final int cols, final int floors) {
        if (this.levelCount < Maze.getMaxLevels()) {
            ...
            this.mazeData = new LayeredDungeon(rows, cols, floors);
            this.levelCount++;
