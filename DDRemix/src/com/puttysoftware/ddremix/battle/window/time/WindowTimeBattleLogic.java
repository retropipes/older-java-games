package com.puttysoftware.ddremix.battle.window.time;
...
import com.puttysoftware.ddremix.ai.window.AbstractWindowAIRoutine;
import com.puttysoftware.ddremix.battle.AbstractBattle;
import com.puttysoftware.ddremix.battle.BattleResults;
import com.puttysoftware.ddremix.battle.damageengines.AbstractDamageEngine;
import com.puttysoftware.ddremix.creatures.AbstractCreature;
import com.puttysoftware.ddremix.creatures.StatConstants;
import com.puttysoftware.ddremix.creatures.monsters.AbstractMonster;
import com.puttysoftware.ddremix.creatures.monsters.BossMonster;
import com.puttysoftware.ddremix.creatures.monsters.MonsterFactory;
...
import com.puttysoftware.ddremix.items.combat.CombatItemChucker;
...
import com.puttysoftware.ddremix.spells.SpellCaster;
...
public class WindowTimeBattleLogic extends AbstractBattle {
    ...
    public void doBattle() {
        try {
            ...
            if (app.getMazeManager().getMaze().getBombs() > 0) {
                // Use Bomb
                app.getMazeManager().getMaze().useBomb();
                ...
                this.battleGUI.setMaxPlayerActionBarValue(PartyManager
                        .getParty().getLeader().getActionBarSpeed());
                this.battleGUI.setMaxEnemyActionBarValue(
                        this.enemy.getActionBarSpeed());
                this.enemyDidDamage = false;
                this.playerDidDamage = false;
    ...
    public void doBattleByProxy() {
        ...
        if (playerCharacter.checkLevelUp()) {
            ...
            DDRemix.getApplication().getGameManager().keepNextMessage();
            DDRemix.getApplication().showMessage(
    ...
    public final void battleDone() {
        ...
        final GameLogicManager gm = DDRemix.getApplication().getGameManager();
        gm.showOutput();
        gm.redrawMaze();
    }
