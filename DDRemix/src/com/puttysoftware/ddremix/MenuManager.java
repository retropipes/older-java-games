...
import com.puttysoftware.ddremix.creatures.characterfiles.CharacterRegistration;
import com.puttysoftware.ddremix.game.InventoryViewer;
import com.puttysoftware.ddremix.game.NoteManager;
import com.puttysoftware.ddremix.game.StatisticsViewer;
...
public class MenuManager {
    ...
    private void createMenus() {
        ...
        this.helpAbout = new JMenuItem("About DDRemix...");
        this.helpObjectHelp = new JMenuItem("DDRemix Object Help");
    ...
    private class EventHandler implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            try {
                ...
                } else if (cmd.equals("About DDRemix...")) {
                    app.getAboutDialog().showAboutDialog();
                } else if (cmd.equals("DDRemix Object Help")) {
