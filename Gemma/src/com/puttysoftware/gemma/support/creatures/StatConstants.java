...
public class StatConstants {
    ...
    static final int STAT_SPEED = 19;
    public static final int STAT_HIT = 20;
    public static final int STAT_EVADE = 21;
    static final int STAT_CAPACITY = 22;
    static final int STAT_MAGIC_POWER = 23;
    static final int STAT_MAGIC_DEFENSE = 24;
    static final int STAT_MAX_LEVEL = 25;
    static final int MAX_STORED_STATS = 15;
    public static final int MAX_DISPLAY_STATS = 25;
    public static final int MAX_STATS = 26;
    // Factors
    static final double FACTOR_STRENGTH_ATTACK = 1.0;
    static final double FACTOR_POWER_ATTACK = 1.0;
    static final double FACTOR_BLOCK_DEFENSE = 1.0;
    static final double FACTOR_BLOCK_MAGIC_DEFENSE = 1.0;
    static final double FACTOR_ABSORB_DEFENSE = 1.0;
    static final double FACTOR_AGILITY_ACTIONS_PER_ROUND = 1.0;
    ...
    static final double FACTOR_INTELLIGENCE_MAGIC_POWER = 1.5;
    ...
    // Other Bases
    static final int MIN_CAPACITY = 500;
