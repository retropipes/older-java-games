...
public abstract class GenericButton extends MapObject {
	...
	// Copy constructor
	public GenericButton(final GenericButton other) {
		super(other);
		try {
			this.offState = other.offState.getClass().getConstructor(MapObject.class).newInstance(other.offState);
			this.onState = other.onState.getClass().getConstructor(MapObject.class).newInstance(other.onState);
