    ...
    protected boolean preMoveObject(final int locX, final int locY,
        ...
        if (dirX == 0 && dirY == -1) {
            if (obj2 instanceof StickyBox && !((StickyBox) obj2).didPreCheck) {
                ...
                proceed = proceed && ((StickyBox) obj2).preMoveObject(locX,
                        locY - 1, locZ, dirX, dirY, laserType,
                        forceUnits - obj2.getMinimumReactionForce());
                if (proceed) {
                    app.getGameManager().updatePushedPosition(locX, locY - 1,
                            locX + dirX, locY - 1 + dirY, (StickyBox) obj2);
                    ((StickyBox) obj2).didMove = true;
                }
            } else if (!(obj2 instanceof StickyBox)) {
                proceed = proceed && super.preMoveObject(locX, locY, locZ, dirX,
                        dirY, laserType, forceUnits);
            }
            if (obj4 instanceof StickyBox && !((StickyBox) obj4).didPreCheck) {
                ((StickyBox) obj4).didPreCheck = true;
                proceed = proceed && ((StickyBox) obj4).preMoveObject(locX - 1,
                        locY, locZ, dirX, dirY, laserType,
                        forceUnits - obj4.getMinimumReactionForce());
                if (proceed) {
                    app.getGameManager().updatePushedPosition(locX - 1, locY,
                            locX - 1 + dirX, locY + dirY, (StickyBox) obj4);
                    ((StickyBox) obj4).didMove = true;
                }
            }
            if (obj6 instanceof StickyBox && !((StickyBox) obj6).didPreCheck) {
                ((StickyBox) obj6).didPreCheck = true;
                proceed = proceed && ((StickyBox) obj6).preMoveObject(locX + 1,
                        locY, locZ, dirX, dirY, laserType,
                        forceUnits - obj6.getMinimumReactionForce());
                if (proceed) {
                    app.getGameManager().updatePushedPosition(locX + 1, locY,
                            locX + 1 + dirX, locY + dirY, (StickyBox) obj6);
            ...
            if (obj8 instanceof StickyBox && !((StickyBox) obj8).didPreCheck) {
                ...
                proceed = proceed && ((StickyBox) obj8).preMoveObject(locX,
                        locY + 1, locZ, dirX, dirY, laserType,
                        forceUnits - obj8.getMinimumReactionForce());
                if (proceed) {
                    app.getGameManager().updatePushedPosition(locX, locY + 1,
                            locX + dirX, locY + 1 + dirY, (StickyBox) obj8);
