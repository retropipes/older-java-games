...
public class Wall extends AbstractWall {
    ...
    public int laserEnteredAction(final int locX, final int locY,
        ...
        if (laserType == LaserTypeConstants.LASER_TYPE_DISRUPTOR) {
            ...
            LTRemix.getApplication().getGameManager().morph(new DisruptedWall(),
                    locX, locY, locZ, this.getPrimaryLayer());
            ...
            LTRemix.getApplication().getGameManager().morph(new HotWall(), locX,
            ...
            LTRemix.getApplication().getGameManager().morph(iw, locX, locY,
