...
public class ExplodingBarrel extends AbstractReactionWall {
    ...
    public int laserEnteredActionHook(final int locX, final int locY,
        ...
        try {
            ...
            // Did tank die?
            final boolean dead = this.laserEnteredActionInnerP1(locX, locY,
                    locZ, false);
            if (dead) {
                // Kill tank
    ...
    private boolean laserEnteredActionInnerP1(final int locX, final int locY,
        ...
        final boolean boom2 = LTRemix.getApplication().getArenaManager()
                .getArena()
                .getCell(locX, locY - 1, locZ, this.getPrimaryLayer())
                .getClass().equals(ExplodingBarrel.class);
        if (boom2) {
            return this.laserEnteredActionInnerP1(locX, locY - 1, locZ, dead);
        }
        final boolean boom4 = LTRemix.getApplication().getArenaManager()
                .getArena()
                .getCell(locX - 1, locY, locZ, this.getPrimaryLayer())
                .getClass().equals(ExplodingBarrel.class);
        if (boom4) {
            return this.laserEnteredActionInnerP1(locX - 1, locY, locZ, dead);
        }
        final boolean boom6 = LTRemix.getApplication().getArenaManager()
                .getArena()
                .getCell(locX + 1, locY, locZ, this.getPrimaryLayer())
                .getClass().equals(ExplodingBarrel.class);
        if (boom6) {
        ...
        final boolean boom8 = LTRemix.getApplication().getArenaManager()
                .getArena()
                .getCell(locX, locY + 1, locZ, this.getPrimaryLayer())
                .getClass().equals(ExplodingBarrel.class);
        if (boom8) {
