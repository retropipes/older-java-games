...
public abstract class AbstractJumpObject extends AbstractMovableObject {
    ...
    public int laserEnteredAction(final int locX, final int locY,
        ...
        final int py = app.getGameManager().getPlayerManager()
                .getPlayerLocationY();
        if (forceUnits > this.getMinimumReactionForce() && this.jumpRows == 0
                && this.jumpCols == 0) {
            ...
            if (this.jumpShot) {
                ...
                if (this.dir1X != 0 && this.dir2X != 0
                        || this.dir1Y != 0 && this.dir2Y != 0) {
                    SoundManager.playSound(SoundConstants.SOUND_LASER_DIE);
                    return DirectionConstants.NONE;
                } else {
                    if (this.dir1X == 0 && this.dir2X == 1 && this.dir1Y == -1
                            && this.dir2Y == 0
                            || this.dir1X == 0 && this.dir2X == -1
                                    && this.dir1Y == 1 && this.dir2Y == 0
                            || this.dir1X == 1 && this.dir2X == 0
                                    && this.dir1Y == 0 && this.dir2Y == -1
                            || this.dir1X == -1 && this.dir2X == 0
                                    && this.dir1Y == 0 && this.dir2Y == 1) {
                        this.flip = true;
                    } else {
