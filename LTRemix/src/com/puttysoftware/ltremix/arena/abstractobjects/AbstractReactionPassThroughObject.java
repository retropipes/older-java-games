...
public abstract class AbstractReactionPassThroughObject
        extends AbstractPassThroughObject {
    // Constructors
    ...
    @Override
    public final int laserEnteredAction(final int locX, final int locY,
        ...
        if (forceUnits >= this.getMinimumReactionForce()) {
            return this.laserEnteredActionHook(locX, locY, locZ, dirX, dirY,
    ...
    @Override
    public final boolean rangeAction(final int locX, final int locY,
            final int locZ, final int dirX, final int dirY, final int rangeType,
            final int forceUnits) {
        if (forceUnits >= this.getMinimumReactionForce()) {
            return this.rangeActionHook(locX, locY, locZ, dirX, dirY, rangeType,
                    forceUnits);
        } else {
            return super.rangeAction(locX, locY, locZ, dirX, dirY, rangeType,
                    forceUnits);
        }
    }

    public abstract int laserEnteredActionHook(int locX, int locY, int locZ,
