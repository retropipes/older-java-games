...
class EditorUndoRedoEngine {
    ...
    void updateUndoHistory(final AbstractArenaObject obj, final int x,
            final int y, final int z, final int w, final int u) {
        this.undoHistory.push(obj, x, y, z, w, u);
    }

    void updateRedoHistory(final AbstractArenaObject obj, final int x,
            final int y, final int z, final int w, final int u) {
    ...
    private static class Link {
        ...
        Link(final AbstractArenaObject obj, final int x, final int y,
                final int z, final int w, final int u) {
            this.mo = obj;
            this.coordX = x;
            this.coordY = y;
            this.coordZ = z;
    ...
    private static class LinkList {
        ...
        public void insertFirst(final AbstractArenaObject obj, final int x,
                final int y, final int z, final int w, final int u) {
    ...
    private static class LinkStack {
        ...
        public void push(final AbstractArenaObject obj, final int x,
                final int y, final int z, final int w, final int u) {
