...
public class MazeObjectList {
    ...
    private final MazeObject[] allObjects = { new MazeGround(), new MazeWall(),
            ...
            new MazeFakeWall(), new MazeKey(), new MazeLock(),
            new MazeTablet(), new MazeTabletSlot(), new MazeFakeFinish(),
            new MazeCrackedWall(), new MazeBomb(), new MazeTeleporter(),
            new MazeInvisibleTeleporter(), new MazeAKey(), new MazeALock(),
            new MazeCKey(), new MazeCLock(), new MazeDKey(), new MazeDLock(),
            new MazeFKey(), new MazeFLock(), new MazeGKey(), new MazeGLock(),
            new MazeKKey(), new MazeKLock(), new MazeLKey(), new MazeLLock(),
            new MazeMKey(), new MazeMLock(), new MazeNKey(), new MazeNLock(),
            new MazePKey(), new MazePLock(), new MazeRKey(), new MazeRLock(),
            new MazeUKey(), new MazeULock(), new MazeZKey(), new MazeZLock(),
            new MazeRandomTeleporter(), new MazeRandomInvisibleTeleporter(),
