...
public class WorldPrefs {
    ...
    private static void setUpGUI() {
        ...
        WorldPrefs.globalVisionRadius = new JSlider(
                WorldPrefs.MIN_VISION_RADIUS, WorldPrefs.MAX_VISION_RADIUS,
                WorldPrefs.DEFAULT_VISION_RADIUS);
        WorldPrefs.globalVisionRadius.setLabelTable(
                WorldPrefs.globalVisionRadius.createStandardLabels(1));
        WorldPrefs.globalVisionRadius.setPaintLabels(true);
        WorldPrefs.globalExploreExpansionRadius = new JSlider(
                WorldPrefs.MIN_VISION_RADIUS, WorldPrefs.MAX_VISION_RADIUS,
                WorldPrefs.DEFAULT_VISION_RADIUS);
        WorldPrefs.globalExploreExpansionRadius
                .setLabelTable(WorldPrefs.globalExploreExpansionRadius
        ...
        WorldPrefs.editorPane
                .setLayout(new GridLayout(WorldPrefs.GRID_LENGTH, 1));
        ...
        public void itemStateChanged(final ItemEvent e) {
            try {
                ...
                if (o.getClass().equals(
                        WorldPrefs.useGlobalVisionRadiusOverride.getClass())) {
                    final JCheckBox check = (JCheckBox) o;
                    if (check
                            .equals(WorldPrefs.useGlobalVisionRadiusOverride)) {
                    ...
                    if (check.equals(
                        ...
                        WorldPrefs.useGlobalVisionModeOverride.getClass())) {
                    final JCheckBox check = (JCheckBox) o;
                    ...
                    if (check.equals(WorldPrefs.globalVisionModeNone)) {
                        ...
                        WorldPrefs.globalVisionModeExplore.getClass())) {
                    final JCheckBox check = (JCheckBox) o;
                    if (check.equals(WorldPrefs.globalVisionModeExplore)) {
                        ...
                        WorldPrefs.globalVisionModeFixedRadius.getClass())) {
                    final JCheckBox check = (JCheckBox) o;
