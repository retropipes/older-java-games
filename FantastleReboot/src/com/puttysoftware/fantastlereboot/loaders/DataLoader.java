...
public class DataLoader {
    ...
    public static int[] loadJobData(final int j) {
        ...
        try (final ResourceStreamReader rsr = new ResourceStreamReader(
                DataLoader.class.getResourceAsStream(
                        "/assets/data/job/" + name + FileExtensions
    ...
    public static String[] loadFaithNameData() {
        try (final ResourceStreamReader rsr = new ResourceStreamReader(
                DataLoader.class.getResourceAsStream(
                        "/assets/data/faith/names" + FileExtensions
                                .getInternalDataExtensionWithPeriod()))) {
            // Fetch data
    ...
    public static int[] loadFaithColorData(final int f) {
        ...
        try (final ResourceStreamReader rsr = new ResourceStreamReader(
                DataLoader.class.getResourceAsStream(
                        "/assets/data/faith/colors/" + name + FileExtensions
                                .getInternalDataExtensionWithPeriod()))) {
            // Fetch data
    ...
    public static int[] loadFaithNumeratorData(final int f) {
        ...
        try (final ResourceStreamReader rsr = new ResourceStreamReader(
                DataLoader.class.getResourceAsStream(
                        "/assets/data/faith/numerator/" + name + FileExtensions
                                .getInternalDataExtensionWithPeriod()))) {
            // Fetch data
    ...
    public static int[] loadFaithDenominatorData(final int f) {
        ...
        try (final ResourceStreamReader rsr = new ResourceStreamReader(
                DataLoader.class
                        .getResourceAsStream("/assets/data/faith/denominator/"
                                + name + FileExtensions
                                        .getInternalDataExtensionWithPeriod()))) {
            // Fetch data
            final int[] data = new int[FaithManager.FAITHS];
    ...
    public static String[] loadMonsterData() {
        try (final ResourceStreamReader rsr = new ResourceStreamReader(
                DataLoader.class.getResourceAsStream(
                        "/assets/data/monster/monsternames" + FileExtensions
                                .getInternalDataExtensionWithPeriod()))) {
            // Fetch data
            final ArrayList<String> data = new ArrayList<>();
            String raw = "0";
    ...
    public static int[] loadRaceData(final int r) {
        ...
        try (final ResourceStreamReader rsr = new ResourceStreamReader(
                DataLoader.class.getResourceAsStream(
                        "/assets/data/race/" + name + FileExtensions
                                .getInternalDataExtensionWithPeriod()))) {
            // Fetch data
