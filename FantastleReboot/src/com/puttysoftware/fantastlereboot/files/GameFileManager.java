...
public final class GameFileManager {
    ...
    private static void loadGameFile(final String filename) {
        if (!FilenameChecker
                .isFilenameOK(GameFileManager.getNameWithoutExtension(
                        GameFileManager.getFileNameOnly(filename)))) {
    ...
    public static boolean suspendGame() {
        ...
        while (!FilenameChecker.isFilenameOK(returnVal)) {
            ...
            if (returnVal != null) {
                ...
                final File file = new File(GameFileManager.getGameDirectory()
                        + returnVal + extension);
                filename = file.getAbsolutePath();
