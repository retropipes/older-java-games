...
public class CharacterLoader {
    ...
    public static PartyMember readCharacter(final XDataReader reader)
        ...
        if (version >= CharacterVersions.V2) {
            ...
            avatarModel = new AvatarImageModel(avatarFamily, avatarHair,
                    avatarSkin, avatarBody, avatarPants, avatarShoes,
                    avatarEyes);
            ...
            avatarModel = new AvatarImageModel(avatarLegacyFamily, avatarHair,
                    avatarSkin);
            pm = PartyManager.getNewPCInstance(ii, r, j, f, n,
                    avatarLegacyFamily, avatarModel);
        }
        ...
        pm.loadPartyMember(lvl, cHP, cMP, gld, load, exp, j, known, k, pAtk,
                pDef, pHP, pMP);
        return pm;
    }
