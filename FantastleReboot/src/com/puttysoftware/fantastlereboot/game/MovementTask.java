...
final class MovementTask extends Thread {
    ...
    private static void updatePositionRelative(final int dirX, final int dirY,
        ...
        do {
            ...
            if (MovementTask.proceed) {
                ...
                if (m.cellRangeCheck(px + fX, py + fY, pz + fZ)) {
                    if (MovementTask.checkSolid(MovementTask.saved, below,
                            nextBelow, nextAbove)) {
                        ...
                        if (MovementTask.proceed) {
                            MovementTask.saved = m.getCell(px, py, pz,
                                    Layers.OBJECT);
                        }
                    } else {
            ...
            loopCheck = MovementTask.checkLoopCondition(below, nextBelow,
                    nextAbove);
    ...
    private static boolean checkLoopCondition(final FantastleObjectModel below,
        ...
        return MovementTask.proceed
                ...
                && !nextBelow.hasFriction() && MovementTask.checkSolid(
                        MovementTask.saved, below, nextBelow, nextAbove);
    }
