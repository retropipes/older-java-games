...
public class PartyManager {
    ...
    public static boolean createParty() {
        ...
        final String[] autoButtons = new String[] { "Automatically",
                "Manually" };
        final int autoResponse = CommonDialogs.showCustomDialog(
                "How should the party be assembled?", "Create Party",
                autoButtons, autoButtons[0]);
    ...
    public static void updatePostKill() {
        ...
        leader.initPostKill(leader.getRace(), leader.getJob(),
                leader.getFaith());
    }
