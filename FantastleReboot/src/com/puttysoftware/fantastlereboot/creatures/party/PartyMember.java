...
public class PartyMember extends Creature {
    ...
    // Constructors
    PartyMember(final ItemInventory ii, final Race r, final Job j,
            final Faith f, final String n, final int af,
    ...
    public void loadPartyMember(final int newLevel, final int chp,
            ...
            final int k, final int pAtk, final int pDef, final int pHP,
            final int pMP) {
