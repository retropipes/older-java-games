...
public abstract class Creature {
    ...
    protected int getInitialStrength() {
        ...
        final int raceFixed = r.getAttribute(
                RaceConstants.ATTRIBUTE_STRENGTH_PER_LEVEL) * level;
        final int jobFixed = j
                .getAttribute(JobConstants.ATTRIBUTE_STRENGTH_MODIFIER);
        final double raceMult = RaceConstants.getLookupTableEntry(
    ...
    protected int getInitialBlock() {
        ...
        final int raceFixed = r
                .getAttribute(RaceConstants.ATTRIBUTE_BLOCK_PER_LEVEL) * level;
        final int jobFixed = j
                .getAttribute(JobConstants.ATTRIBUTE_BLOCK_MODIFIER);
        final double raceMult = RaceConstants.getLookupTableEntry(
    ...
    protected int getInitialVitality() {
        ...
        final int raceFixed = r.getAttribute(
                RaceConstants.ATTRIBUTE_VITALITY_PER_LEVEL) * level;
        final int jobFixed = j
                .getAttribute(JobConstants.ATTRIBUTE_VITALITY_MODIFIER);
        final double raceMult = RaceConstants.getLookupTableEntry(
    ...
    protected int getInitialIntelligence() {
        ...
        final int raceFixed = r.getAttribute(
                RaceConstants.ATTRIBUTE_INTELLIGENCE_PER_LEVEL) * level;
        final int jobFixed = j
                .getAttribute(JobConstants.ATTRIBUTE_INTELLIGENCE_MODIFIER);
        final double raceMult = RaceConstants.getLookupTableEntry(
    ...
    protected int getInitialAgility() {
        ...
        final int raceFixed = r.getAttribute(
                RaceConstants.ATTRIBUTE_AGILITY_PER_LEVEL) * level;
        final int jobFixed = j
                .getAttribute(JobConstants.ATTRIBUTE_AGILITY_MODIFIER);
        final double raceMult = RaceConstants.getLookupTableEntry(
    ...
    protected int getInitialLuck() {
        ...
        final int raceFixed = r
                .getAttribute(RaceConstants.ATTRIBUTE_LUCK_PER_LEVEL) * level;
        final int jobFixed = j
                .getAttribute(JobConstants.ATTRIBUTE_LUCK_MODIFIER);
        final double raceMult = RaceConstants.getLookupTableEntry(
