...
import com.puttysoftware.mazerunner2.maze.games.GameFilter;
import com.puttysoftware.mazerunner2.maze.games.GameFinder;
import com.puttysoftware.mazerunner2.maze.games.GameLoadTask;
import com.puttysoftware.mazerunner2.maze.games.GameSaveTask;
...
public class MazeManager {
    // Fields
    private LegacyMazeManager legacy;
    ...
    // Constructors
    public MazeManager() {
        this.legacy = new LegacyMazeManager();
        this.loaded = false;
        this.isDirty = false;
    ...
    public void handleDeferredSuccess(boolean value) {
        ...
        this.setDirty(false);
        MazeRunnerII.getApplication().getGameManager().stateChanged();
        MazeRunnerII.getApplication().getEditor().mazeChanged();
        MazeRunnerII.getApplication().getMenuManager().checkFlags();
    }
    ...
    public void setLastUsedMaze(String newFile) {
        ...
        if (!this.loaded) {
            ...
            if (extension.equals(Extension.getMazeExtension())) {
                ...
                CommonDialogs
                    ...
                    .getLegacyMazeExtension())
                    || extension.equals(LegacyExtension
                            .getLegacyGameExtension())
                    || extension.equals(LegacyExtension
                            .getLegacySavedGameExtension())) {
                this.legacy.legacyLoadFromOSHandler(filename);
            }
        }
    }

    public boolean loadLegacyMaze() {
        return this.legacy.loadLegacyMaze();
    }

    public boolean loadLegacyGame() {
        return this.legacy.loadLegacyGame();
    }

    public boolean importLegacyGame() {
        return this.legacy.importLegacyGame();
    }
    ...
    public boolean loadGame() {
        ...
        if (saved) {
            String gameDir = MazeManager.getGameDirectory();
    ...
    private static void saveFile(String filename, boolean isSavedGame,
        ...
        MazeRunnerII.getApplication().showMessage("Saving " + sg + " file...");
        if (locked) {
