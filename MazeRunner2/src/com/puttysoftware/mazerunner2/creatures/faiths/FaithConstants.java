 ...
 */
package com.puttysoftware.mazerunner2.creatures.faiths;

import java.awt.Color;
import java.io.IOException;
import java.util.ArrayList;

import com.puttysoftware.mazerunner2.datamanagers.FaithDataManager;
            ...
            try {
                ...
                try (final ResourceStreamReader rsr1 = new ResourceStreamReader(
                        FaithDataManager.class
                                .getResourceAsStream("/com/puttysoftware/mazerunner2/resources/data/faith/catalog.txt"))) {
                    String input1 = "";
                    while (input1 != null) {
                ...
                try (final ResourceStreamReader rsr2 = new ResourceStreamReader(
                        FaithDataManager.class
                                .getResourceAsStream("/com/puttysoftware/mazerunner2/resources/data/faith/colors.txt"))) {
                    String input2 = "";
                    while (input2 != null) {
