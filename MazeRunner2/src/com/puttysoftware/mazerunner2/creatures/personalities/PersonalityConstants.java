 ...
 */
package com.puttysoftware.mazerunner2.creatures.personalities;

import java.io.IOException;
import java.util.ArrayList;

import com.puttysoftware.mazerunner2.datamanagers.PersonalityDataManager;
        ...
        if (!PersonalityConstants.INITED) {
            try (final ResourceStreamReader rsr = new ResourceStreamReader(
                    PersonalityDataManager.class
                            .getResourceAsStream("/com/puttysoftware/mazerunner2/resources/data/personality/catalog.txt"))) {
                // Fetch data
