 ...
 */
package com.puttysoftware.mazerunner2.creatures.races;

import java.io.IOException;
import java.util.ArrayList;

import com.puttysoftware.mazerunner2.datamanagers.RaceDataManager;
        ...
        if (!RaceConstants.INITED) {
            try (final ResourceStreamReader rsr = new ResourceStreamReader(
                    RaceDataManager.class
                            .getResourceAsStream("/com/puttysoftware/mazerunner2/resources/data/race/catalog.txt"))) {
                // Fetch data
