...
public class StatConstants {
    ...
    static final double FACTOR_ABSORB_DEFENSE = 0.1;
    static final double FACTOR_AGILITY_MAP_ACTIONS_PER_ROUND = 1.0;
    static final double FACTOR_AGILITY_WINDOW_ACTIONS_PER_ROUND = 0.1;
