...
import com.puttysoftware.mazerunner2.creatures.characterfiles.CharacterRegistration;
...
import com.puttysoftware.mazerunner2.game.InventoryViewer;
import com.puttysoftware.mazerunner2.game.NoteManager;
import com.puttysoftware.mazerunner2.game.PrestigeViewer;
import com.puttysoftware.mazerunner2.game.StatisticsViewer;
...
public class MenuManager {
    ...
    private JMenuItem fileNew, fileOpen, fileOpenGame, fileImportGame,
            ...
            fileExit;
    private JMenuItem fileLegacyOpen, fileLegacyOpenGame, fileLegacyImportGame;
    ...
    public void setGameMenus() {
        ...
        this.fileLegacyOpen.setEnabled(false);
        this.fileLegacyOpenGame.setEnabled(false);
        this.fileLegacyImportGame.setEnabled(false);
        ...
        ArrayList<AbstractEditor> allEditors = MazeRunnerII.getApplication()
                .getAllEditors();
    ...
    public void setMainMenus() {
        ...
        this.fileLegacyOpen.setEnabled(true);
        this.fileLegacyOpenGame.setEnabled(true);
        this.fileLegacyImportGame.setEnabled(true);
        this.fileExit.setEnabled(true);
        this.editUndo.setEnabled(false);
        this.editRedo.setEnabled(false);
        this.editCutLevel.setEnabled(false);
    ...
    private void createMenus() {
        ...
        JMenu fileLegacySubMenu = new JMenu("Legacy");
        ...
        this.fileLegacyOpen = new JMenuItem("Open Legacy...");
        this.fileLegacyOpenGame = new JMenuItem("Open Legacy Game...");
        this.fileLegacyImportGame = new JMenuItem("Import Legacy Game...");
        ...
        this.helpAbout = new JMenuItem("About MazeRunnerII...");
        this.helpObjectHelp = new JMenuItem("MazeRunnerII Object Help");
        ...
        this.fileLegacyOpen.addActionListener(this.handler);
        this.fileLegacyOpenGame.addActionListener(this.handler);
        this.fileLegacyImportGame.addActionListener(this.handler);
        ...
        fileLegacySubMenu.add(this.fileLegacyOpen);
        fileLegacySubMenu.add(this.fileLegacyOpenGame);
        fileLegacySubMenu.add(this.fileLegacyImportGame);
        fileMenu.add(this.fileNew);
        fileMenu.add(this.fileOpen);
        fileMenu.add(this.fileOpenGame);
        fileMenu.add(this.fileImportGame);
        fileMenu.add(fileLegacySubMenu);
        ...
        public void actionPerformed(final ActionEvent e) {
            try {
                ...
                if (cmd.equals("New...")) {
                    ...
                    app.getMazeManager().setLoaded(loaded);
                } else if (cmd.equals("Open Legacy...")) {
                    loaded = app.getMazeManager().loadLegacyMaze();
                    app.getMazeManager().setLoaded(loaded);
                } else if (cmd.equals("Open Legacy Game...")) {
                    loaded = app.getMazeManager().loadLegacyGame();
                    app.getMazeManager().setLoaded(loaded);
                } else if (cmd.equals("Import Legacy Game...")) {
                    loaded = app.getMazeManager().importLegacyGame();
                    app.getMazeManager().setLoaded(loaded);
                    ...
                    ba.endTurn();
                } else if (cmd.equals("About MazeRunnerII...")) {
                    app.getAboutDialog().showAboutDialog();
                } else if (cmd.equals("MazeRunnerII Object Help")) {
