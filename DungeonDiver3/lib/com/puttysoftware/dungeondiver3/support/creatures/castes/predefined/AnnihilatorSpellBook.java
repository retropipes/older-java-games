...
public class AnnihilatorSpellBook extends SpellBook {
    ...
    protected void defineSpells() {
        Effect spell0Effect = new Effect("Force Ball", 1);
        ...
        Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ENEMY,
                GameSoundConstants.SOUND_COLD_DAMAGE);
        this.spells[0] = spell0;
        Effect spell1Effect = new Effect("Force Ball All", 1);
        ...
        Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ALL_ENEMIES,
                GameSoundConstants.SOUND_COLD_DAMAGE);
        this.spells[1] = spell1;
        Effect spell2Effect = new Effect("Cutter Cloud", 1);
        spell2Effect.setEffect(Effect.EFFECT_ADD,
                StatConstants.STAT_CURRENT_HP, -4);
        ...
        Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ENEMY,
                GameSoundConstants.SOUND_MISSED);
        this.spells[2] = spell2;
        Effect spell3Effect = new Effect("Cutter Cloud All", 1);
        ...
        Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ALL_ENEMIES,
                GameSoundConstants.SOUND_MISSED);
        this.spells[3] = spell3;
        Effect spell4Effect = new Effect("Vortex", 1);
        ...
        spell4Effect
                .setMessage(Effect.MESSAGE_INITIAL, "You conjure a vortex!");
        ...
        Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.ONE_ENEMY,
                GameSoundConstants.SOUND_OFFENSIVE_MAGIC);
        this.spells[4] = spell4;
        Effect spell5Effect = new Effect("Vortex All", 1);
        ...
        Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ALL_ENEMIES,
                GameSoundConstants.SOUND_OFFENSIVE_MAGIC);
        this.spells[5] = spell5;
        Effect spell6Effect = new Effect("Air Tear", 1);
        ...
        Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ALL_ENEMIES,
                GameSoundConstants.SOUND_WEAKNESS);
        this.spells[6] = spell6;
        Effect spell7Effect = new Effect("Power Drain", 1);
