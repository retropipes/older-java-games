...
class ListWithDescDialog extends JDialog implements ActionListener {
    ...
    public static String showDialog(Component frameComp,
            ...
            String[] possibleValues, String initialValue, String descValue,
    ...
    private ListWithDescDialog(Frame frame, Component locationComp,
        ...
        this.list.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                descArea.setText(ListWithDescDialog.this.descs[ListWithDescDialog.this.list
                        .getSelectedIndex()]);
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        if ("OK".equals(e.getActionCommand())) {
            ListWithDescDialog.value = this.list.getSelectedValue();
