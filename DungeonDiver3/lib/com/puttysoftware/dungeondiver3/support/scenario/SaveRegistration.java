...
public class SaveRegistration {
    ...
    private static final String MAC_SAVE_DIR = "/Library/Application Support/Putty Software/DungeonDiver3/Saves";
    private static final String WIN_SAVE_DIR = "\\Putty Software\\DungeonDiver3\\Saves";
    private static final String UNIX_SAVE_DIR = "/.puttysoftware/dungeondiver3/saves";
    ...
    private static ArrayList<String> readSaveRegistry() {
        ...
        try (FileInputStream fis = new FileInputStream(
                basePath + File.separator + "SaveRegistry"
