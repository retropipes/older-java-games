 ...
 */
package com.puttysoftware.dungeondiver3.namer.editor;
...
import com.puttysoftware.dungeondiver3.namer.generic.GenericObjectEditor;
...
public class NameEditor extends GenericObjectEditor {
    ...
    public NameEditor() {
        super("name", "Name Editor", Application.EDITOR_NAME, 2, 2,
    ...
    protected void loadObject() {
        this.cachedNames = DungeonDiver3.getApplication().getScenarioManager()
