...
public abstract class GenericObjectEditor extends GenericEditor {
    ...
    protected GenericObjectEditor(final String newType, final String newSource,
            final int editorID, final int actionCommandLength,
            final int actionButtonRows, final int actionButtonCols,
            final boolean autoStoreEnabled) {
        super(newType, newSource, editorID);
    ...
    private class EventHandler implements ActionListener, FocusListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                int num = Integer.parseInt(e.getActionCommand().substring(
                        ge.actionCmdLen));
