...
import com.puttysoftware.dungeondiver3.scenario.names.NamesFileManager;
...
public class ScenarioManager {
    ...
    void handleDeferredSuccess() {
        this.setDirty(false);
        DungeonDiver3.getApplication().getGameManager().stateChanged();
        DungeonDiver3.getApplication().getMenuManager().checkFlags();
    }
