...
import com.puttysoftware.mazer5d.objects.ChainTeleport;
import com.puttysoftware.mazer5d.objects.Destination;
import com.puttysoftware.mazer5d.objects.Empty;
import com.puttysoftware.mazer5d.objects.EmptyVoid;
import com.puttysoftware.mazer5d.objects.FinishTo;
import com.puttysoftware.mazer5d.objects.InvisibleChainTeleport;
import com.puttysoftware.mazer5d.objects.InvisibleOneShotChainTeleport;
import com.puttysoftware.mazer5d.objects.InvisibleOneShotTeleport;
import com.puttysoftware.mazer5d.objects.InvisibleTeleport;
import com.puttysoftware.mazer5d.objects.MetalButton;
import com.puttysoftware.mazer5d.objects.MovingFinish;
import com.puttysoftware.mazer5d.objects.OneShotChainTeleport;
import com.puttysoftware.mazer5d.objects.OneShotTeleport;
import com.puttysoftware.mazer5d.objects.Player;
import com.puttysoftware.mazer5d.objects.RandomInvisibleOneShotTeleport;
import com.puttysoftware.mazer5d.objects.RandomInvisibleTeleport;
import com.puttysoftware.mazer5d.objects.RandomOneShotTeleport;
import com.puttysoftware.mazer5d.objects.RandomTeleport;
import com.puttysoftware.mazer5d.objects.StairsDown;
import com.puttysoftware.mazer5d.objects.StairsUp;
import com.puttysoftware.mazer5d.objects.Teleport;
...
public class MazeEditor {
    ...
    public MazeEditor() {
        ...
        this.treasurePicker.updatePickerLayout(ImageConstants.MAX_WINDOW_SIZE);
    ...
    private void checkMenus() {
        ...
        if (app.inEditor()) {
            ...
            if (m.getLevels() == Maze.getMinLevels()) {
                app.disableRemoveLevel();
            } else {
                app.enableRemoveLevel();
            }
            ...
            try {
                ...
                if (app.getMazeManager().getMaze()
                        .is3rdDimensionWraparoundEnabled()) {
                    app.enableUpOneFloor();
                } else {
                    if (this.elMgr.getEditorLocationZ() == this.elMgr
                            .getMaxEditorLocationZ()) {
                        app.disableUpOneFloor();
                    } else {
                        app.enableUpOneFloor();
                    }
                }
                if (this.elMgr.getEditorLocationW() == this.elMgr
                    ...
                    app.disableDownOneLevel();
                } else {
                    app.enableDownOneLevel();
                }
                if (this.elMgr.getEditorLocationW() == this.elMgr
                        .getMaxEditorLocationW()) {
                    app.disableUpOneLevel();
                } else {
                    app.enableUpOneLevel();
                }
            ...
            if (this.elMgr != null) {
                if (this.elMgr
                    ...
                    app.enableSetStartPoint();
                } else {
                    app.disableSetStartPoint();
                }
            } else {
                app.disableSetStartPoint();
            }
            ...
            if (this.engine.tryBoth()) {
                app.disableClearHistory();
            } else {
                app.enableClearHistory();
            }
        }
    }
            ...
            for (y = this.evMgr.getViewingWindowLocationY(); y <= this.evMgr
                ...
                try {
                    ...
                    this.drawGrid[xFix][yFix].setIcon(
                            ObjectImageManager.getObjectImage(obj1, false));
    ...
    public void setMetalButtonTarget(final int x, final int y) {
        ...
        app.getMazeManager().getMaze().setCell(
                new MetalButton(destX, destY, destZ),
                this.elMgr.getEditorLocationX(),
                this.elMgr.getEditorLocationY(), this.elMgr.getCameFromZ(),
                MazeConstants.LAYER_OBJECT);
        this.horzScroll.removeAdjustmentListener(this.mbhandler);
    ...
    public void fillLevelRandomly() {
        if (this.confirmNonUndoable(
            ...
            if (Mazer5D.getApplication().useFillRuleSets()) {
                Mazer5D.getApplication().getMazeManager().getMaze()
