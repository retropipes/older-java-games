...
import com.puttysoftware.mazer5d.generic.RandomGenerationRule;
import com.puttysoftware.mazer5d.generic.TypeConstants;
import com.puttysoftware.mazer5d.objects.BarrierGenerator;
import com.puttysoftware.mazer5d.objects.CrackedWall;
import com.puttysoftware.mazer5d.objects.Crevasse;
...
import com.puttysoftware.mazer5d.objects.EnragedBarrierGenerator;
import com.puttysoftware.mazer5d.objects.ForceField;
import com.puttysoftware.mazer5d.objects.HotRock;
import com.puttysoftware.mazer5d.objects.Ice;
import com.puttysoftware.mazer5d.objects.IcedBarrierGenerator;
...
import com.puttysoftware.mazer5d.objects.PoisonedBarrierGenerator;
import com.puttysoftware.mazer5d.objects.ShockedBarrierGenerator;
        ...
        for (x = 0; x < lt.getColumns(); x++) {
            for (y = 0; y < lt.getRows(); y++) {
                for (z = 0; z < lt.getFloors(); z++) {
                    for (e = 0; e < MazeConstants.LAYER_COUNT; e++) {
                        lt.setCell(Mazer5D.getApplication().getObjects()
