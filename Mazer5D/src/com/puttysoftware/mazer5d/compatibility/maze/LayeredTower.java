    ...
    public void radialScanBurnGround(final int x, final int y, final int z,
        ...
        for (u = x - r; u <= x + r; u++) {
            for (v = y - r; v <= y + r; v++) {
                try {
                    // Burn the ground
                    this.setCell(new Dirt(), u, v, z, Layers.GROUND);
                } catch (final ArrayIndexOutOfBoundsException aioob) {
                    // Do nothing
                }
            }
    ...
    public void radialScanPoisonGround(final int x, final int y, final int z,
        ...
        for (u = x - r; u <= x + r; u++) {
            for (v = y - r; v <= y + r; v++) {
                try {
                    // Poison the ground
                    this.setCell(new Slime(), u, v, z, Layers.GROUND);
                } catch (final ArrayIndexOutOfBoundsException aioob) {
                    // Do nothing
                }
            }
    ...
    public void radialScanShockGround(final int x, final int y, final int z,
        ...
        for (u = x - r; u <= x + r; u++) {
            for (v = y - r; v <= y + r; v++) {
                try {
                    // Shock the ground
                    this.setCell(new ForceField(), u, v, z, Layers.GROUND);
                } catch (final ArrayIndexOutOfBoundsException aioob) {
                    // Do nothing
                }
            }
