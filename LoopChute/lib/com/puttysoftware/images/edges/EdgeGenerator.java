...
public class EdgeGenerator {
    ...
    public static String[] generateAllEdgedImageNameSuffixes() {
        final String[] results = new String[] { "_south", "_east",
                "_southeast", "_northeast", "_southwest", "_northwest",
                "_north", "_west", "_southeast_inverted",
                "_northeast_inverted", "_southwest_inverted",
                "_northwest_inverted", };
        return results;
    }

    public static String[] generateAllEdgedImageFriendlyNameSuffixes() {
        final String[] results = new String[] { "South", "East", "Southeast",
                "Northeast", "Southwest", "Northwest", "North", "West",
                "Southeast Inverted", "Northeast Inverted",
