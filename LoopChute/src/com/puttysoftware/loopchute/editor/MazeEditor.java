...
import com.puttysoftware.loopchute.objects.BlockTeleport;
import com.puttysoftware.loopchute.objects.ChainTeleport;
import com.puttysoftware.loopchute.objects.Destination;
...
import com.puttysoftware.loopchute.objects.InvisibleBlockTeleport;
import com.puttysoftware.loopchute.objects.InvisibleChainTeleport;
import com.puttysoftware.loopchute.objects.InvisibleOneShotChainTeleport;
import com.puttysoftware.loopchute.objects.InvisibleOneShotTeleport;
import com.puttysoftware.loopchute.objects.InvisibleTeleport;
import com.puttysoftware.loopchute.objects.OneShotChainTeleport;
import com.puttysoftware.loopchute.objects.OneShotTeleport;
import com.puttysoftware.loopchute.objects.Player;
import com.puttysoftware.loopchute.objects.RandomInvisibleOneShotTeleport;
import com.puttysoftware.loopchute.objects.RandomInvisibleTeleport;
import com.puttysoftware.loopchute.objects.RandomOneShotTeleport;
import com.puttysoftware.loopchute.objects.RandomTeleport;
import com.puttysoftware.loopchute.objects.StairsDown;
import com.puttysoftware.loopchute.objects.StairsUp;
import com.puttysoftware.loopchute.objects.Teleport;
import com.puttysoftware.loopchute.objects.TwoWayTeleport;
...
public class MazeEditor {
    ...
    public MazeEditor() {
        ...
        final MazeObjectList objectList = LoopChute.getApplication()
                .getObjects();
    ...
    public void updateEditorLevelAbsolute(final int w) {
        this.elMgr.setEditorLocationW(w);
        // Level Change
        LoopChute.getApplication().getMazeManager().getMaze().switchLevel(w);
        this.fixLimits();
        this.setUpGUI();
        this.checkMenus();
        this.redrawEditor();
                ...
                try {
                    ...
                    if (u == y && v == x) {
                        ...
                        this.drawGrid[xFix][yFix].setIcon(
                                GraphicsManager.getCompositeImage(img1, img2));
                    }
                } catch (final ArrayIndexOutOfBoundsException ae) {
                    this.drawGrid[xFix][yFix].setIcon(GraphicsManager.getImage(
                            "Void", "Void", ColorConstants.COLOR_NONE, "",
        ...
        try {
            ...
            final BufferedImageIcon img1 = GraphicsManager.getImage(
                    obj1.editorRenderHook(y, x,
                            this.elMgr.getEditorLocationZ()),
                    obj1.getBaseName(), obj1.getTemplateColor(),
                    obj1.getAttributeName(), obj1.getAttributeTemplateColor());
            final BufferedImageIcon img2 = GraphicsManager.getImage(
                    obj2.editorRenderHook(y, x,
                            this.elMgr.getEditorLocationZ()),
                    obj2.getBaseName(), obj2.getTemplateColor(),
                    obj2.getAttributeName(), obj2.getAttributeTemplateColor());
            final BufferedImageIcon img3 = GraphicsManager.getImage(
                    obj3.editorRenderHook(y, x,
                            this.elMgr.getEditorLocationZ()),
                    obj3.getBaseName(), obj3.getTemplateColor(),
                    obj3.getAttributeName(), obj3.getAttributeTemplateColor());
            this.drawGrid[xFix][yFix].setIcon(
                    GraphicsManager.getVirtualCompositeImage(img1, img2, img3));
    ...
    public void setTeleportDestination(final int x, final int y) {
        ...
        this.secondaryPane.addMouseListener(this.mhandler);
        this.checkMenus();
        LoopChute.getApplication().showMessage("Destination set.");
        app.getMazeManager().setDirty(true);
        this.redrawEditor();
    }
    ...
    public void editPlayerLocation() {
        ...
        LoopChute.getApplication().showMessage("Click to set start point");
    }
    ...
    void setPlayerLocation(final int x, final int y) {
        ...
        try {
            ...
            LoopChute.getApplication().showMessage("Start point set.");
        } catch (final ArrayIndexOutOfBoundsException aioob) {
    ...
    public void fillLevel() {
        if (this.confirmNonUndoable(
            ...
            LoopChute.getApplication().getMazeManager().getMaze().fill();
            LoopChute.getApplication().showMessage("Level filled.");
    ...
    public void fillFloor() {
        if (this.confirmNonUndoable(
            ...
            LoopChute.getApplication().showMessage("Floor filled.");
            LoopChute.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
    ...
    public void fillLevelRandomly() {
        if (this.confirmNonUndoable(
            ...
            if (LoopChute.getApplication().getMenuManager().useFillRuleSets()) {
                LoopChute.getApplication().getMazeManager().getMaze()
            ...
            LoopChute.getApplication().showMessage("Level randomly filled.");
            LoopChute.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
    ...
    public void fillFloorRandomly() {
        if (this.confirmNonUndoable(
            ...
            LoopChute.getApplication().showMessage("Floor randomly filled.");
            LoopChute.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
    ...
    public void fillLevelAndLayer() {
        if (this.confirmNonUndoable(
            ...
            LoopChute.getApplication().showMessage("Level and layer filled.");
            LoopChute.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
        ...
        if (this.confirmNonUndoable(
            ...
            LoopChute.getApplication().getMazeManager().getMaze()
                    .fillFloorAndLayer(this.elMgr.getEditorLocationZ(),
                            this.elMgr.getEditorLocationE());
            LoopChute.getApplication().showMessage("Floor and layer filled.");
            LoopChute.getApplication().getMazeManager().setDirty(true);
            this.redrawEditor();
        }
    }
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            this.evMgr.setViewingWindowLocationX(
                                    0 - (this.evMgr.getViewingWindowSizeX() - 1)
                                            / 2);
                            this.evMgr.setViewingWindowLocationY(
                                    0 - (this.evMgr.getViewingWindowSizeY() - 1)
                                            / 2);
                            app.getMazeManager().getMaze().fillLevel(
    ...
    void goToDestination(final int x, final int y) {
        if (this.goToDestMode) {
            ...
            final MazeObject there = LoopChute.getApplication().getMazeManager()
    ...
    public void exitEditor() {
        ...
        gm.stateChanged();
        LoopChute.getApplication().getGUIManager().showGUI();
    }
    ...
    public void undo() {
        ...
        if (x != -1 && y != -1 && z != -1 && w != -1) {
            ...
            LoopChute.getApplication().showMessage("Nothing to undo");
        }
    }
    ...
    public void redo() {
        ...
        if (x != -1 && y != -1 && z != -1 && w != -1) {
            ...
            LoopChute.getApplication().showMessage("Nothing to redo");
        }
    }
