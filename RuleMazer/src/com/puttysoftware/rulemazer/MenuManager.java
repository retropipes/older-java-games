...
public class MenuManager {
    ...
    private void createMenus() {
        ...
        this.helpAbout = new JMenuItem("About RuleMazer...");
        this.helpGeneralHelp = new JMenuItem("RuleMazer Help");
        this.helpObjectHelp = new JMenuItem("RuleMazer Object Help");
    ...
    private class EventHandler implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            try {
                ...
                } else if (cmd.equals("About RuleMazer...")) {
                    app.getAboutDialog().showAboutDialog();
                } else if (cmd.equals("RuleMazer Help")) {
                    app.getGeneralHelpManager().showHelp();
                } else if (cmd.equals("RuleMazer Object Help")) {
