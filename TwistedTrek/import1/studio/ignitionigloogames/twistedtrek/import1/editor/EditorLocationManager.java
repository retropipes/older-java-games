...
public class EditorLocationManager {
	...
	public void setEditorLocation(final int valX, final int valY, final int valZ, final int valW, final int valE) {
		this.locW = valW;
		this.locE = valE;
		this.locX = valX;
		this.locY = valY;
	...
	public void offsetEditorLocation(final int valX, final int valY, final int valZ, final int valW, final int valE) {
		this.locW += valW;
		this.locE += valE;
		this.locX += valX;
		this.locY += valY;
