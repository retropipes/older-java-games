...
public class MultiplierValues {
	...
	private static final double[] values = { 0.25, 1.0 / 3.0, 0.5, 2.0 / 3.0, 0.75, 1.0, 4.0 / 3.0, 1.5, 2.0, 3.0,
			4.0 };
	...
	public static double getRandomNormalValue() {
		final RandomRange r = new RandomRange(0, MultiplierValues.bellCurve.length - 1);
