...
public class EquipmentFactory {
	...
	public static Equipment createMonsterWeapon(final int material) {
		final Equipment e = new Equipment(WeaponMaterialConstants.MATERIAL_COMMON_NAMES[material] + " Claws",
				ItemCategoryConstants.ITEM_CATEGORY_NONE, 0, 0,
				EquipmentCategoryConstants.EQUIPMENT_CATEGORY_ONE_HANDED_WEAPON, material);
		e.setFirstSlotUsed(EquipmentSlotConstants.SLOT_MAINHAND);
		e.setSecondSlotUsed(EquipmentSlotConstants.SLOT_OFFHAND);
	...
	public static Equipment createArmor(final int material, final int armorType) {
		final Equipment e = new Equipment(
				ArmorMaterialConstants.MATERIAL_COMMON_NAMES[material] + " " + ArmorConstants.ARMOR[armorType],
				ItemCategoryConstants.ITEM_CATEGORY_NONE, 0, 0, EquipmentCategoryConstants.EQUIPMENT_CATEGORY_ARMOR,
				material);
