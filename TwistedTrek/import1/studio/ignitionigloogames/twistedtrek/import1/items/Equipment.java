...
public class Equipment extends Item {
	...
	private Equipment(final Item i, final int equipCategory, final int newMaterialID) {
		super(i.getName(), i.getCategory(), i.getInitialUses(), i.getWeightPerUse());
	...
	Equipment(final String itemName, final int itemCat, final int itemInitialUses, final int itemWeightPerUse,
			final int equipCategory, final int newMaterialID) {
		super(itemName, itemCat | ItemCategoryConstants.ITEM_CATEGORY_EQUIPMENT, itemInitialUses, itemWeightPerUse);
		this.equipCat = equipCategory;
		this.materialID = newMaterialID;
		this.firstSlotUsed = EquipmentSlotConstants.SLOT_NONE;
		this.secondSlotUsed = EquipmentSlotConstants.SLOT_NONE;
	...
	public static Equipment readEquipment(final XDataReader dr) throws IOException {
	...
	public void writeEquipment(final XDataWriter dw) throws IOException {
		super.writeItem(dw);
