...
public class MazeObjectList {
	...
	private final MazeObject[] allObjects = { new Empty(), new Grass(), new Dirt(), new Sand(), new Snow(),
			new Tundra(), new Tile(), new Ice(), new Water(), new Slime(), new Lava(), new SunkenBlock(),
			new ForceField(), new Player(), new Finish(), new FakeFinish(), new FinishTo(), new Wall(),
			new InvisibleWall(), new FakeWall(), new BlueWallOff(), new BlueWallOn(), new GreenWallOff(),
			new GreenWallOn(), new MagentaWallOff(), new MagentaWallOn(), new OrangeWallOff(), new OrangeWallOn(),
			new PurpleWallOff(), new PurpleWallOn(), new RedWallOff(), new RedWallOn(), new WhiteWallOff(),
			...
			new DamageableWall(), new CrackedWall(), new DamagedWall(), new MasterTrappedWall(), new TrappedWall0(),
			new TrappedWall1(), new TrappedWall2(), new TrappedWall3(), new TrappedWall4(), new TrappedWall5(),
			new TrappedWall6(), new TrappedWall7(), new TrappedWall8(), new TrappedWall9(), new TrappedWall10(),
			new TrappedWall11(), new TrappedWall12(), new TrappedWall13(), new TrappedWall14(), new TrappedWall15(),
			new TrappedWall16(), new TrappedWall17(), new TrappedWall18(), new TrappedWall19(), new BrickWall(),
			new Hammer(), new Tablet(), new TabletSlot(), new EnergySphere(), new APlug(), new APort(), new BPlug(),
			new BPort(), new CPlug(), new CPort(), new DPlug(), new DPort(), new EPlug(), new EPort(), new FPlug(),
			new FPort(), new GPlug(), new GPort(), new HPlug(), new HPort(), new IPlug(), new IPort(), new JPlug(),
			new JPort(), new KPlug(), new KPort(), new LPlug(), new LPort(), new MPlug(), new MPort(), new NPlug(),
			new NPort(), new OPlug(), new OPort(), new PPlug(), new PPort(), new RPlug(), new RPort(), new UPlug(),
			new UPort(), new ZPlug(), new ZPort(), new Key(), new Lock(), new BlueKey(), new BlueLock(), new GreenKey(),
			new GreenLock(), new MagentaKey(), new MagentaLock(), new OrangeKey(), new OrangeLock(), new PurpleKey(),
			new PurpleLock(), new RedKey(), new RedLock(), new WhiteKey(), new WhiteLock(), new YellowKey(),
			...
			new RedButton(), new WhiteButton(), new YellowButton(), new CyanButton(), new MetalButton(), new Teleport(),
			new InvisibleTeleport(), new RandomTeleport(), new RandomInvisibleTeleport(), new RandomOneShotTeleport(),
			new RandomInvisibleOneShotTeleport(), new OneShotTeleport(), new InvisibleOneShotTeleport(),
			new TwoWayTeleport(), new ControllableTeleport(), new OneShotControllableTeleport(), new StairsUp(),
			new StairsDown(), new Pit(), new InvisiblePit(), new PushableBlock(), new PullableBlock(),
			...
			new HealBoots(), new RegenBoots(), new MoneyBoots(), new ExperienceBoots(), new MetalBoots(), new NoBoots(),
			new GlueBoots(), new AquaBoots(), new BioHazardBoots(), new FireBoots(), new AnnihilationWand(),
			new FinishMakingWand(), new WallMakingWand(), new TeleportWand(), new WallBreakingWand(),
			new DisarmTrapWand(), new RemoteActionWand(), new RotationWand(), new WarpWand(), new EmptyVoid(),
			new ClockwiseRotationTrap(), new CounterclockwiseRotationTrap(), new UTurnTrap(), new ConfusionTrap(),
			new DizzinessTrap(), new DrunkTrap(), new WallMakingTrap(), new RotationTrap(), new WarpTrap(),
			new DamageTrap(), new DrainTrap(), new EasierTrap(), new HarderTrap(), new ArrowTrap(),
			new MasterWallTrap(), new WallTrap0(), new WallTrap1(), new WallTrap2(), new WallTrap3(), new WallTrap4(),
			new WallTrap5(), new WallTrap6(), new WallTrap7(), new WallTrap8(), new WallTrap9(), new WallTrap10(),
			new WallTrap11(), new WallTrap12(), new WallTrap13(), new WallTrap14(), new WallTrap15(), new WallTrap16(),
			new WallTrap17(), new WallTrap18(), new WallTrap19(), new TreasureChest(), new DimnessGem(),
			new DarknessGem(), new LightnessGem(), new BrightnessGem(), new MinorHealPotion(), new MinorHurtPotion(),
			new MinorUnknownPotion(), new MajorHealPotion(), new MajorHurtPotion(), new MajorUnknownPotion(),
			new SuperHealPotion(), new SuperHurtPotion(), new SuperUnknownPotion(), new MinorRegenPotion(),
			new MinorDrainPotion(), new MinorRandomPotion(), new MajorRegenPotion(), new MajorDrainPotion(),
			new MajorRandomPotion(), new SuperRegenPotion(), new SuperDrainPotion(), new SuperRandomPotion(),
			new HorizontalBarrier(), new VerticalBarrier(), new BarrierGenerator(), new ArmorShop(), new Bank(),
			new Healer(), new ItemShop(), new Regenerator(), new SpellShop(), new WeaponsShop(), new Monster(),
			new Bomb(), new SmokeBomb(), new WarpBomb(), new IceBomb(), new ShuffleBomb(), new IceBow() };
	...
	public BufferedImageIcon[] getAllEditorAppearances() {
		...
		for (int x = 0; x < allEditorAppearances.length; x++) {
			allEditorAppearances[x] = GraphicsManager.getTransformedImage(this.allObjects[x].getName());
		}
