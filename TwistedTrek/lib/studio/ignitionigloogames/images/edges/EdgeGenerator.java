...
public class EdgeGenerator {
	// Constants
	private static final String[] NAME_SUFFIXES = new String[] { "_south", "_east", "_southeast", "_northeast",
			"_southwest", "_northwest", "_north", "_west", "_southeast_inverted", "_northeast_inverted",
			"_southwest_inverted", "_northwest_inverted", };
	private static final String[] FRIENDLY_NAME_SUFFIXES = new String[] { "South", "East", "Southeast", "Northeast",
			"Southwest", "Northwest", "North", "West", "Southeast Inverted", "Northeast Inverted", "Southwest Inverted",
			"Northwest Inverted", };
	...
	public static BufferedImageIcon generateEdgedImage(final BufferedImageIcon img1, final BufferedImageIcon img2,
		...
		if (img1.getWidth() != img2.getWidth() || img1.getHeight() != img2.getHeight()
			...
			throw new IllegalArgumentException("Input images must be the same size and square!");
		}
