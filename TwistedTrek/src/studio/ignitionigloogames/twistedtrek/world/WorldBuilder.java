...
public class WorldBuilder {
	...
	public WorldBuilder(final int newWidth, final int newHeight, final int newDepth) {
		this.width = newWidth;
		this.height = newHeight;
		this.depth = newDepth;
		this.tiles = new Tile[newWidth][newHeight][newDepth];
		this.regions = new int[newWidth][newHeight][newDepth];
		this.nextRegion = 1;
	}
