...
class PreferencesGUIManager {
	...
	private static final int[] VIEWING_WINDOW_TRIGGERS = new int[] { 0, 0, 0, 950, 1075, 1200, 1325, 1450, 1575, 1700 };
	...
	private void loadPrefs() {
		...
		try {
			this.viewingWindowChoices[PreferencesManager.getViewingWindowSizeIndex()].setSelected(true);
		} catch (IllegalArgumentException | ArrayIndexOutOfBoundsException e) {
			this.viewingWindowChoices[PreferencesGUIManager.DEFAULT_SIZE_INDEX].setSelected(true);
			PreferencesManager.setViewingWindowSizeIndex(PreferencesGUIManager.DEFAULT_SIZE_INDEX);
			PreferencesManager.writePrefs();
		}
		this.sound.setSelected(PreferencesManager.getSoundsEnabled());
		this.useMapBattleEngine.setSelected(PreferencesManager.useMapBattleEngine());
