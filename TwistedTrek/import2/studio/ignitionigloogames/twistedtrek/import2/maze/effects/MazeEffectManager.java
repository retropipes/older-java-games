...
public class MazeEffectManager {
	...
	public MazeEffectManager() {
		...
		this.activeEffects[MazeEffectConstants.EFFECT_POWER_GATHER] = new PowerGather(0);
		this.activeEffects[MazeEffectConstants.EFFECT_POWER_WITHER] = new PowerWither(0);
		// Create GUI
	...
	public void activateEffect(final int effectID) {
		this.activateEffectInternal(effectID,
				MazeEffectConstants.DURATIONS[PreferencesManager.getGameDifficulty()][effectID]);
	}
