...
public final class GameLogicManager {
	...
	int curr = DynamicDungeon.getApplication().getDungeonManager()
		.getDungeon().getStones() * 100;
	int max = this.stoneCount;
	...
	try {
	    final AbstractDungeonObject target1 = m.getCell(destX, destY,
		    destZ, DungeonConstants.LAYER_GROUND);
	    final AbstractDungeonObject target2 = m.getCell(destX, destY,
