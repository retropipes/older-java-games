...
public class VorbisFormatConversionProvider
        extends MatrixFormatConversionProvider {
    private static final AudioFormat[] INPUT_FORMATS = {
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 32000.0F, -1, 1,
                    -1, -1, false), // 0
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 32000.0F, -1, 2,
                    -1, -1, false), // 1
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 44100.0F, -1, 1,
                    -1, -1, false), // 2
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 44100.0F, -1, 2,
                    -1, -1, false), // 3
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 48000.0F, -1, 1,
                    -1, -1, false), // 4
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 48000.0F, -1, 2,
                    -1, -1, false), // 5
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 16000.0F, -1, 1,
                    -1, -1, false), // 18
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 16000.0F, -1, 2,
                    -1, -1, false), // 19
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 22050.0F, -1, 1,
                    -1, -1, false), // 20
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 22050.0F, -1, 2,
                    -1, -1, false), // 21
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 24000.0F, -1, 1,
                    -1, -1, false), // 22
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 24000.0F, -1, 2,
                    -1, -1, false), // 23
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 8000.0F, -1, 1, -1,
                    -1, false), // 36
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 8000.0F, -1, 2, -1,
                    -1, false), // 37
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 11025.0F, -1, 1,
                    -1, -1, false), // 38
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 11025.0F, -1, 2,
                    -1, -1, false), // 39
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 12000.0F, -1, 1,
                    -1, -1, false), // 40
            new AudioFormat(VorbisAudioFileReader.VORBISENC, 12000.0F, -1, 2,
                    -1, -1, false), // 41
    };
    ...
    private static final boolean[][] CONVERSIONS = { {
            ...
            VorbisFormatConversionProvider.f, VorbisFormatConversionProvider.f,
            VorbisFormatConversionProvider.f, VorbisFormatConversionProvider.f,
            VorbisFormatConversionProvider.t, VorbisFormatConversionProvider.t,
            VorbisFormatConversionProvider.f, VorbisFormatConversionProvider.f,
            VorbisFormatConversionProvider.f, VorbisFormatConversionProvider.f,
            VorbisFormatConversionProvider.f, VorbisFormatConversionProvider.f,
            VorbisFormatConversionProvider.f, VorbisFormatConversionProvider.f,
            VorbisFormatConversionProvider.f,
            VorbisFormatConversionProvider.f }, // 0
            { VorbisFormatConversionProvider.f,
                    VorbisFormatConversionProvider.f,
                    VorbisFormatConversionProvider.f,
                    VorbisFormatConversionProvider.f,
                    ...
                    VorbisFormatConversionProvider.f,
                    VorbisFormatConversionProvider.f,
                    VorbisFormatConversionProvider.t,
                    VorbisFormatConversionProvider.t,
                    VorbisFormatConversionProvider.f,
                    VorbisFormatConversionProvider.f,
                    VorbisFormatConversionProvider.f,
    ...
    public AudioInputStream getAudioInputStream(final AudioFormat targetFormat,
        ...
        if (this.isConversionSupported(targetFormat,
                audioInputStream.getFormat())) {
            return new DecodedVorbisAudioInputStream(targetFormat,
                    audioInputStream);
        } else {
