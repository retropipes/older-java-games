...
class Drft {
    ...
    void backward(final float[] data) {
        ...
        Drft.drftb1(this.n, data, this.trigcache, this.trigcache, this.n,
                this.splitcache);
    }

    void init(final int n1) {
        this.n = n1;
        this.trigcache = new float[3 * n1];
        this.splitcache = new int[32];
        Drft.fdrffti(n1, this.trigcache, this.splitcache);
    }
    ...
    static void drfti1(final int n, final float[] wa, final int index,
            final int[] ifac) {
    ...
    static void dradf2(final int ido, final int l1, final float[] cc,
            final float[] ch, final float[] wa1, final int index) {
        int i, k;
        float ti2, tr2;
        ...
        if (ido != 2) {
            ...
            for (k = 0; k < l1; k++) {
                ...
                for (i = 2; i < ido; i += 2) {
                    ...
                    t5 += 2;
                    t6 += 2;
                    tr2 = wa1[index + i - 2] * cc[t3 - 1]
                            + wa1[index + i - 1] * cc[t3];
                    ti2 = wa1[index + i - 2] * cc[t3]
    ...
    static void dradf4(final int ido, final int l1, final float[] cc,
            final float[] ch, final float[] wa1, final int index1,
            final float[] wa2, final int index2, final float[] wa3,
            final int index3) {
    ...
    static void dradfg(final int ido, final int ip, final int l1,
            final int idl1, final float[] cc, final float[] c1,
            final float[] c2, final float[] ch, final float[] ch2,
            final float[] wa, final int index) {
    ...
    static void drftf1(final int n, final float[] c, final float[] ch,
            final float[] wa, final int[] ifac) {
        int i, k1, l1, l2;
        int na, kh, nf;
        ...
        for (k1 = 0; k1 < nf; k1++) {
            ...
            loop: while (true) {
                ...
                case 100:
                    ...
                    ix3 = ix2 + ido;
                    if (na != 0) {
                        Drft.dradf4(ido, l1, ch, c, wa, iw - 1, wa, ix2 - 1, wa,
                                ix3 - 1);
                    } else {
                        Drft.dradf4(ido, l1, c, ch, wa, iw - 1, wa, ix2 - 1, wa,
                                ix3 - 1);
                    }
                    state = 110;
                    break;
                ...
                case 104:
                    ...
                    break;
                case 109:
                    Drft.dradfg(ido, ip, l1, idl1, ch, ch, ch, c, c, wa,
                            iw - 1);
                    na = 0;
                    //$FALL-THROUGH$
                case 110:
    ...
    static void dradb2(final int ido, final int l1, final float[] cc,
            final float[] ch, final float[] wa1, final int index) {
        int i, k, t0, t1, t2, t3, t4, t5, t6;
        float ti2, tr2;
        t0 = l1 * ido;
    ...
    static void dradb3(final int ido, final int l1, final float[] cc,
            final float[] ch, final float[] wa1, final int index1,
            final float[] wa2, final int index2) {
    ...
    static void dradb4(final int ido, final int l1, final float[] cc,
            final float[] ch, final float[] wa1, final int index1,
            final float[] wa2, final int index2, final float[] wa3,
            final int index3) {
    ...
    static void dradbg(final int ido, final int ip, final int l1,
            final int idl1, final float[] cc, final float[] c1,
            final float[] c2, final float[] ch, final float[] ch2,
            final float[] wa, final int index) {
        int idij, ipph = 0, i, j, k, l, ik, is, t0 = 0, t1, t2, t3, t4, t5, t6,
                t7, t8, t9, t10 = 0, t11, t12;
        float dc2, ai1, ai2, ar1, ar2, ds2;
        int nbd = 0;
        float dcp = 0, arg, dsp = 0, ar1h, ar2h;
        int ipp2 = 0;
    ...
    static void drftb1(final int n, final float[] c, final float[] ch,
            final float[] wa, final int index, final int[] ifac) {
        int i, k1, l1, l2 = 0;
        int na;
        ...
        for (k1 = 0; k1 < nf; k1++) {
            ...
            loop: while (true) {
                ...
                case 100:
                    ...
                    ix3 = ix2 + ido;
                    if (na != 0) {
                        Drft.dradb4(ido, l1, ch, c, wa, index + iw - 1, wa,
                                index + ix2 - 1, wa, index + ix3 - 1);
                    } else {
                        Drft.dradb4(ido, l1, c, ch, wa, index + iw - 1, wa,
                                index + ix2 - 1, wa, index + ix3 - 1);
                    }
                    na = 1 - na;
                    state = 115;
                ...
                case 106:
                    ...
                    ix2 = iw + ido;
                    if (na != 0) {
                        Drft.dradb3(ido, l1, ch, c, wa, index + iw - 1, wa,
                                index + ix2 - 1);
                    } else {
                        Drft.dradb3(ido, l1, c, ch, wa, index + iw - 1, wa,
                                index + ix2 - 1);
                    }
                    na = 1 - na;
                    state = 115;
                ...
                case 109:
                    if (na != 0) {
                        Drft.dradbg(ido, ip, l1, idl1, ch, ch, ch, c, c, wa,
                                index + iw - 1);
                    } else {
                        Drft.dradbg(ido, ip, l1, idl1, c, c, c, ch, ch, wa,
                                index + iw - 1);
                    }
                    if (ido == 1) {
                        na = 1 - na;
