...
public class StreamState {
    ...
    StreamState(final int serialno1) {
        this();
        this.init(serialno1);
    }
     ...
     * @param serialno1
     */
    public final void init(final int serialno1) {
    ...
    void lacing_expand(final int needed) {
        if (this.lacing_storage <= this.lacing_fill + needed) {
            ...
            System.arraycopy(this.lacing_vals, 0, foo, 0,
                    this.lacing_vals.length);
            this.lacing_vals = foo;
            final long[] bar = new long[this.lacing_storage];
            System.arraycopy(this.granule_vals, 0, bar, 0,
    ...
    public int packetin(final Packet op) {
        ...
        if (this.body_returned != 0) {
            ...
            if (this.body_fill != 0) {
                System.arraycopy(this.body_data, this.body_returned,
                        this.body_data, 0, this.body_fill);
            }
         ...
         */
        System.arraycopy(op.packet_base, op.packet, this.body_data,
        ...
        this.granulepos = this.granule_vals[this.lacing_fill
                + j] = op.granulepos;
    ...
    public int packetout(final Packet op) {
        ...
        /* Gather the whole packet. We'll have no holes or a partial packet */
        {
            ...
            op.e_o_s = this.lacing_vals[ptr]
                    & 0x200; /* last packet of the stream? */
            op.b_o_s = this.lacing_vals[ptr]
    ...
    public int pagein(final Page og) {
        ...
        final long granulepos1 = og.granulepos();
        final int _serialno = og.serialno();
        final int _pageno = og.pageno();
        final int segments = header_base[header1 + 26] & 0xff;
        // clean up 'returned data'
        {
            ...
            if (br != 0) {
                this.body_fill -= br;
                if (this.body_fill != 0) {
                    System.arraycopy(this.body_data, br, this.body_data, 0,
                            this.body_fill);
                }
                this.body_returned = 0;
            }
            if (lr != 0) {
                ...
                if (this.lacing_fill - lr != 0) {
                    System.arraycopy(this.lacing_vals, lr, this.lacing_vals, 0,
                            this.lacing_fill - lr);
                    System.arraycopy(this.granule_vals, lr, this.granule_vals,
                            0, this.lacing_fill - lr);
                }
                this.lacing_fill -= lr;
        ...
        if (_pageno != this.pageno) {
            ...
            if (continued != 0) {
                ...
                for (; segptr < segments; segptr++) {
                    final int val = header_base[header1 + 27 + segptr] & 0xff;
                    body += val;
                    bodysize -= val;
                    if (val < 255) {
                        segptr++;
        ...
        if (bodysize != 0) {
            ...
            System.arraycopy(body_base, body, this.body_data, this.body_fill,
                    bodysize);
        ...
        }
        {
            ...
            if (saved != -1) {
                this.granule_vals[saved] = granulepos1;
            }
        }
        if (eos != 0) {
            this.e_o_s = 1;
    ...
    public int flush(final Page og) {
        ...
        System.arraycopy("OggS".getBytes(Charset.forName("US-ASCII")), 0,
                this.header, 0, 4);
        ...
        if (this.pageno == -1) {
            this.pageno = 0; /*
                              * because someone called stream_reset; this would
                              * be a strange thing to do in an encode stream,
        ...
        System.arraycopy(this.lacing_vals, vals, this.lacing_vals, 0,
                this.lacing_fill * 4);
        System.arraycopy(this.granule_vals, vals, this.granule_vals, 0,
                this.lacing_fill * 8);
        this.body_returned += bytes;
    ...
    public int pageout(final Page og) {
        if (this.e_o_s != 0 && this.lacing_fill != 0
                || /* 'were done, now flush' case */ this.body_fill
                        - this.body_returned > 4096
