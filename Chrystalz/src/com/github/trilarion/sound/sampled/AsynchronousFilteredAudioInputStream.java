...
public abstract class AsynchronousFilteredAudioInputStream
        extends AudioInputStream implements CircularBuffer.BufferListener {
    private static final Logger LOG = Logger
            .getLogger(AsynchronousFilteredAudioInputStream.class.getName());
     ...
     */
    public AsynchronousFilteredAudioInputStream(final AudioFormat outputFormat,
            final long lLength) {
        this(outputFormat, lLength,
                AsynchronousFilteredAudioInputStream.DEFAULT_BUFFER_SIZE,
     ...
     */
    public AsynchronousFilteredAudioInputStream(final AudioFormat outputFormat,
            final long lLength, final int nBufferSize,
            final int nMinAvailable) {
        /*
        ...
        super(new ByteArrayInputStream(
                AsynchronousFilteredAudioInputStream.EMPTY_BYTE_ARRAY),
                outputFormat, lLength);
        ...
        this.m_circularBuffer = new CircularBuffer(nBufferSize, false, // blocking
                ...
                this); // trigger
        AsynchronousFilteredAudioInputStream.LOG.log(Level.FINE,
                "TAsynchronousFilteredAudioInputStream.<init>(): end");
    }
    ...
    @Override
    public int read(final byte[] abData, final int nOffset, final int nLength)
            throws IOException {
        AsynchronousFilteredAudioInputStream.LOG.log(Level.FINE,
