...
public class AudioFormats {
    ...
    public static boolean matches(final AudioFormat format1,
            final AudioFormat format2) {
        ...
        return format1.getEncoding().equals(format2.getEncoding()) && (format2
                ...
                && AudioFormats.doMatch(format1.getChannels(),
                        format2.getChannels())
                && AudioFormats.doMatch(format1.getSampleSizeInBits(),
                        format2.getSampleSizeInBits())
                && AudioFormats.doMatch(format1.getFrameSize(),
                        format2.getFrameSize())
                && AudioFormats.doMatch(format1.getSampleRate(),
                        format2.getSampleRate())
                && AudioFormats.doMatch(format1.getFrameRate(),
                        format2.getFrameRate());
    }
}
