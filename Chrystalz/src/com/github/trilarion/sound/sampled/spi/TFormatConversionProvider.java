...
public abstract class TFormatConversionProvider
    ...
    public AudioInputStream getAudioInputStream(
        ...
        final AudioFormat targetFormat = new AudioFormat(targetEncoding,
        ...
        TFormatConversionProvider.LOG.log(Level.FINE,
                "trying to convert to {0}", targetFormat);
    ...
    public boolean isConversionSupported(final AudioFormat targetFormat,
        ...
        TFormatConversionProvider.LOG.log(Level.FINE, "class: {0}",
                this.getClass().getName());
        TFormatConversionProvider.LOG.log(Level.FINE,
                "checking if conversion possible");
        TFormatConversionProvider.LOG.log(Level.FINE, "from: {0}",
                sourceFormat);
        TFormatConversionProvider.LOG.log(Level.FINE, "to: {0}", targetFormat);
        final AudioFormat[] aTargetFormats = this
                .getTargetFormats(targetFormat.getEncoding(), sourceFormat);
        for (final AudioFormat aTargetFormat : aTargetFormats) {
            TFormatConversionProvider.LOG.log(Level.FINE,
                    "checking against possible target format: {0}",
                    aTargetFormat);
