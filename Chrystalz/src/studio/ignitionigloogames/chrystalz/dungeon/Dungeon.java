...
public class Dungeon {
    ...
    public int computeFinalBossMoveDirection(final int locX, final int locY) {
        ...
        final int relX = px - locX;
        final int relY = py - locY;
        int moveX = 0;
        int moveY = 0;
        if (relX != 0) {
        ...
        final boolean canMove = !this.getCell(locX + moveX, locY + moveY,
                DungeonConstants.LAYER_OBJECT).isSolid();
        if (canMove) {
            return DirectionResolver.resolveRelativeDirection(moveX, moveY);
        }
        final int moveX1L = DirectionResolver.rotate45LeftX(moveX, moveY);
        final int moveY1L = DirectionResolver.rotate45LeftY(moveX, moveY);
        final boolean canMove1L = !this.getCell(locX + moveX1L, locY + moveY1L,
                DungeonConstants.LAYER_OBJECT).isSolid();
        if (canMove1L) {
            return DirectionResolver.resolveRelativeDirection(moveX1L, moveY1L);
        }
        final int moveX1R = DirectionResolver.rotate45RightX(moveX, moveY);
        final int moveY1R = DirectionResolver.rotate45RightY(moveX, moveY);
        final boolean canMove1R = !this.getCell(locX + moveX1R, locY + moveY1R,
                DungeonConstants.LAYER_OBJECT).isSolid();
        if (canMove1R) {
            return DirectionResolver.resolveRelativeDirection(moveX1R, moveY1R);
        }
        final int moveX2L = DirectionResolver.rotate45LeftX(moveX1L, moveY1L);
        final int moveY2L = DirectionResolver.rotate45LeftY(moveX1L, moveY1L);
        final boolean canMove2L = !this.getCell(locX + moveX2L, locY + moveY2L,
                DungeonConstants.LAYER_OBJECT).isSolid();
        if (canMove2L) {
            return DirectionResolver.resolveRelativeDirection(moveX2L, moveY2L);
        }
        final int moveX2R = DirectionResolver.rotate45RightX(moveX1R, moveY1R);
        final int moveY2R = DirectionResolver.rotate45RightY(moveX1R, moveY1R);
        final boolean canMove2R = !this.getCell(locX + moveX2R, locY + moveY2R,
                DungeonConstants.LAYER_OBJECT).isSolid();
        if (canMove2R) {
            return DirectionResolver.resolveRelativeDirection(moveX2R, moveY2R);
        }
        final int moveX3L = DirectionResolver.rotate45LeftX(moveX2L, moveY2L);
        final int moveY3L = DirectionResolver.rotate45LeftY(moveX2L, moveY2L);
        final boolean canMove3L = !this.getCell(locX + moveX3L, locY + moveY3L,
                DungeonConstants.LAYER_OBJECT).isSolid();
        if (canMove3L) {
            return DirectionResolver.resolveRelativeDirection(moveX3L, moveY3L);
        }
        final int moveX3R = DirectionResolver.rotate45RightX(moveX2R, moveY2R);
        final int moveY3R = DirectionResolver.rotate45RightY(moveX2R, moveY2R);
        final boolean canMove3R = !this.getCell(locX + moveX3R, locY + moveY3R,
                DungeonConstants.LAYER_OBJECT).isSolid();
        if (canMove3R) {
            return DirectionResolver.resolveRelativeDirection(moveX3R, moveY3R);
        }
        final int moveX4 = DirectionResolver.rotate45LeftX(moveX3L, moveY3L);
        final int moveY4 = DirectionResolver.rotate45LeftY(moveX3L, moveY3L);
