...
public class MazeObjectList {
    ...
    public MazeObjectList() {
        final MazeObject[] allObjects = { new Empty(), new Grass(), new Dirt(),
                ...
                new BridgedWaterVertical(), new Player(), new SunStone(),
                new MoonStone(), new Wall(), new InvisibleWall(),
                new FakeWall(), new DamageableWall(), new CrackedWall(),
                new DamagedWall(), new CrumblingWall(),
                ...
                new Axe(), new Tree(), new CutTree(), new Key(), new Lock(),
