...
import com.puttysoftware.brainmaze.resourcemanagers.MusicManager;
...
class GameGUIManager {
    ...
    void initViewManager() {
        if (this.vwMgr == null) {
            this.vwMgr = BrainMaze.getApplication().getGameManager()
                    .getViewManager();
            this.setUpGUI();
        }
    }
    ...
    private void setUpGUI() {
        ...
        this.outputFrame = new JFrame("BrainMaze");
    ...
    private class EventHandler implements KeyListener, WindowListener,
        ...
        public void handleMovement(final KeyEvent e) {
            try {
                final GameLogicManager glm = BrainMaze.getApplication()
                        .getGameManager();
        ...
        public void mouseClicked(final MouseEvent e) {
            try {
                final GameLogicManager gm = BrainMaze.getApplication()
                        .getGameManager();
                if (e.isShiftDown()) {
                    final int x = e.getX();
                    final int y = e.getY();
