...
public class MenuManager {
    ...
    private JMenuItem gameObjectInventory, gameReset;
    ...
    private void createMenus() {
        ...
        this.helpAbout = new JMenuItem("About BrainMaze...");
        this.helpObjectHelp = new JMenuItem("BrainMaze Object Help");
    ...
    private class EventHandler implements ActionListener {
        ...
        private void actionPerformedHelp(final String cmd) {
            final Application app = BrainMaze.getApplication();
            if (cmd.equals("About BrainMaze...")) {
                app.getAboutDialog().showAboutDialog();
            } else if (cmd.equals("BrainMaze Object Help")) {
