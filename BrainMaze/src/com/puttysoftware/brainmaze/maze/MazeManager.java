...
import com.puttysoftware.brainmaze.maze.games.GameFilter;
import com.puttysoftware.brainmaze.maze.games.GameFinder;
import com.puttysoftware.brainmaze.maze.games.GameLoadTask;
...
public class MazeManager {
    ...
    private static final String MAC_DIR = "/Library/Application Support/Putty Software/BrainMaze/Games/";
    private static final String WIN_DIR = "\\Putty Software\\BrainMaze\\Games\\";
    private static final String UNIX_DIR = "/.puttysoftware/brainmaze/games/";
    ...
    public void handleDeferredSuccess(final boolean value) {
        ...
        this.setDirty(false);
        BrainMaze.getApplication().getGameManager().stateChanged();
        BrainMaze.getApplication().getEditor().mazeChanged();
        BrainMaze.getApplication().getMenuManager().checkFlags();
    }
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (extension.equals(Extension.getGameExtension())) {
                    ...
                    if (!file.getParentFile().exists()) {
                        ...
                        if (!okay) {
                            BrainMaze.getErrorLogger().logError(new IOException(
                    ...
                    try {
                        ...
                        BrainMaze.getErrorLogger().logError(ioe);
                    }
                    MazeManager.loadFile(filename, false, true);
                } else {
                    CommonDialogs.showDialog(
    ...
    private static void saveFile(final String filename,
        ...
        BrainMaze.getApplication().showMessage("Saving " + sg + " file...");
        if (locked) {
