...
public class Extension {
    // Constants
    private static final String GAME_EXTENSION = "braingame";
    private static final String PREFERENCES_EXTENSION = "xml";
    private static final String MAZE_EXTENSION = "brainmaze";
    private static final String SAVED_GAME_EXTENSION = "brainsave";
    private static final String RULE_SET_EXTENSION = "brainrule";
