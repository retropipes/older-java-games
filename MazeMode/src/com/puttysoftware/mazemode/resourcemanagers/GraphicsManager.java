...
public class GraphicsManager {
    ...
    private static final String DEFAULT_LOAD_PATH = "/com/puttysoftware/mazemode/resources/graphics/";
    ...
    public static void useCustomLoadPath(final String customLoadPath,
        ...
        MazeMode.getApplication().invalidateImageCaches();
    }

    public static void useDefaultLoadPath() {
        GraphicsManager.LOAD_PATH = GraphicsManager.DEFAULT_LOAD_PATH;
        GraphicsManager.LOAD_CLASS = GraphicsManager.class;
        ImageCache.flushCache();
        StatImageCache.flushCache();
        MazeMode.getApplication().invalidateImageCaches();
    }
