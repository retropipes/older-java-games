...
public class ScoreTracker {
    ...
    private static final String MAC_DIR = "/Library/Application Support/Putty Software/MazeMode/Scores/";
    private static final String WIN_DIR = "\\Putty Software\\MazeMode\\Scores\\";
    private static final String UNIX_DIR = "/.mazemode/scores/";
    ...
    public void setScoreFile(final String filename) {
        ...
        this.ssMgr = new SavedScoreManager(1, 10,
                ScoreManager.SORT_ORDER_ASCENDING, 0L, "MazeMode High Scores",
