...
public class MenuManager {
    ...
    private JMenuItem fileNew, fileOpen, fileOpenRecent, fileClose, fileSave,
            fileSaveAs, filePrint, fileExit;
    ...
    private KeyStroke fileNewAccel, fileOpenAccel, fileOpenRecentAccel,
            fileCloseAccel, fileSaveAccel, fileSaveAsAccel, filePrintAccel;
    ...
    public void setGameMenus() {
        ...
        this.fileOpenRecent.setEnabled(false);
    ...
    public void setMainMenus() {
        ...
        this.fileOpenRecent.setEnabled(true);
        this.fileExit.setEnabled(true);
        this.editUndo.setEnabled(false);
        this.editRedo.setEnabled(false);
        this.editCutLevel.setEnabled(false);
    ...
    private void createMenus() {
        ...
        this.fileOpenRecent = new JMenuItem("Open Recent...");
        this.fileOpenRecent.setAccelerator(this.fileOpenRecentAccel);
        ...
        this.helpAbout = new JMenuItem("About MazeMode...");
        this.helpObjectHelp = new JMenuItem("MazeMode Help");
        this.fileNew.addActionListener(this.handler);
        this.fileOpen.addActionListener(this.handler);
        this.fileOpenRecent.addActionListener(this.handler);
        ...
        this.fileMenu.add(this.fileOpenRecent);
        ...
        public void actionPerformed(final ActionEvent e) {
            try {
                ...
                if (cmd.equals("New...")) {
                    ...
                    app.getMazeManager().setLoaded(loaded);
                } else if (cmd.equals("Open Recent...")) {
                    loaded = app.getMazeManager().loadRegisteredMaze();
                    app.getMazeManager().setLoaded(loaded);
                ...
                } else if (cmd.equals("About MazeMode...")) {
                    app.getAboutDialog().showAboutDialog();
                } else if (cmd.equals("MazeMode Help")) {
