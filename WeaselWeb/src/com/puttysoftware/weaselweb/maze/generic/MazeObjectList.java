...
public class MazeObjectList {
    ...
    private final MazeObject[] allObjects = { new Empty(), new Grass(),
            ...
            new EnergySphere(), new GarnetSquare(), new GarnetWall(),
            new GoldenSquare(), new GoldenWall(), new RubySquare(),
            new RubyWall(), new SapphireSquare(), new SapphireWall(),
            new SilverSquare(), new SilverWall(), new TopazSquare(),
            new TopazWall(), new Key(), new Lock(), new BlueKey(),
            new BlueLock(), new GreenKey(), new GreenLock(), new MagentaKey(),
            new MagentaLock(), new OrangeKey(), new OrangeLock(),
            new PurpleKey(), new PurpleLock(), new RedKey(), new RedLock(),
            new RoseKey(), new RoseLock(), new SeaweedKey(), new SeaweedLock(),
            new SkyKey(), new SkyLock(), new WhiteKey(), new WhiteLock(),
            new YellowKey(), new YellowLock(), new CyanKey(), new CyanLock(),
            new MetalKey(), new MetalDoor(), new Door(), new BlueButton(),
            new GreenButton(), new MagentaButton(), new OrangeButton(),
            new PurpleButton(), new RedButton(), new RoseButton(),
            new SeaweedButton(), new SkyButton(), new WhiteButton(),
            new YellowButton(), new CyanButton(), new MetalButton(),
            new Teleport(), new InvisibleTeleport(), new RandomTeleport(),
    ...
    public BufferedImageIcon[] getAllEditorAppearances() {
        ...
        for (int x = 0; x < allEditorAppearances.length; x++) {
            allEditorAppearances[x] = ImageManager
    ...
    public BufferedImageIcon[] getAllGroundLayerEditorAppearances() {
        ...
        for (int x = 0; x < this.allObjects.length; x++) {
            if (this.allObjects[x].getLayer() == MazeConstants.LAYER_GROUND) {
                tempAllGroundLayerEditorAppearances[x] = ImageManager
                        .getTransformedImage(this.allObjects[x].getName());
            }
        }
    ...
    public BufferedImageIcon[] getAllObjectLayerEditorAppearances() {
        ...
        for (int x = 0; x < this.allObjects.length; x++) {
            if (this.allObjects[x].getLayer() == MazeConstants.LAYER_OBJECT) {
                tempAllObjectLayerEditorAppearances[x] = ImageManager
                        .getTransformedImage(this.allObjects[x].getName());
            }
        }
