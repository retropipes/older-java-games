...
public class MazeObjectList {
    ...
    private final MazeObject[] allObjects = { new Empty(), new Grass(),
            ...
            new TabletSlot(), new EnergySphere(), new GarnetSquare(),
            ...
            new TopazSquare(), new TopazWall(), new Key(), new Lock(),
            new BlueKey(), new BlueLock(), new GreenKey(), new GreenLock(),
            new MagentaKey(), new MagentaLock(), new OrangeKey(),
            new OrangeLock(), new PurpleKey(), new PurpleLock(), new RedKey(),
            new RedLock(), new RoseKey(), new RoseLock(), new SeaweedKey(),
            new SeaweedLock(), new SkyKey(), new SkyLock(), new WhiteKey(),
            ...
            new OneShotControllableTeleport(), new ConditionalTeleport(),
