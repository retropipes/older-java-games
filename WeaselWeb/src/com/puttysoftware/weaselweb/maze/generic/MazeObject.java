...
public abstract class MazeObject implements DirectionConstants, TypeConstants,
    ...
    public BufferedImageIcon gameRenderHook(final int x, final int y,
        ...
        final BufferedImageIcon baseImage = ImageManager
                .getTransformedCompositeImage(icon1, tt1, null, null, false);
        ...
        if (ourAttributes != null && ourAttributes.length > 0) {
            ...
            for (final Attribute ourAttribute : ourAttributes) {
                final BufferedImageIcon icon2 = ImageManager
                        .getImage(ourAttribute.getImageName());
                final TemplateTransform tt2 = ourAttribute
                        .getTemplateTransform();
                soFar = ImageManager.getTransformedCompositeImage(soFar, null,
                        icon2, tt2, true);
            }
            return soFar;
        } else {
