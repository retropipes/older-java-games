...
public class OSVersionInfo implements Comparable<OSVersionInfo> {
    ...
    public static final OSVersionInfo OSX_TIGER = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 4, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_TIGER_LATEST = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 4, 11, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_LEOPARD = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 5, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_LEOPARD_LATEST = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 5, 8, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_SNOW_LEOPARD = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 6, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_SNOW_LEOPARD_LATEST = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 6, 8, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_LION = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 7, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_LION_LATEST = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 7, 3, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_MOUNTAIN_LION = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 8, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo OSX_MOUNTAIN_LION_LATEST = new OSVersionInfo(
            OSVersionInfo.MAC_OS_X, 10, 8, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_2K = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 5, 0, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_2K_LATEST = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 5, 0, 4, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_XP = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 5, 1, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_XP_LATEST = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 5, 1, 3, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_VISTA = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 6, 0, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_VISTA_LATEST = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 6, 0, 2, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_SEVEN = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 6, 1, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_SEVEN_LATEST = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 6, 1, 1, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN_EIGHT = new OSVersionInfo(
            OSVersionInfo.WINDOWS, 6, 2, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX_22 = new OSVersionInfo(
            OSVersionInfo.LINUX, 2, 2, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX_24 = new OSVersionInfo(
            OSVersionInfo.LINUX, 2, 4, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX_26 = new OSVersionInfo(
            OSVersionInfo.LINUX, 2, 6, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX_30 = new OSVersionInfo(
            OSVersionInfo.LINUX, 3, 0, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX_32 = new OSVersionInfo(
            OSVersionInfo.LINUX, 3, 2, OSVersionInfo.OS_VERSION_ANY,
            OSVersionInfo.OS_VERSION_ANY);
    // Fields
